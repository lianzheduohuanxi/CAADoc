...

{
    ...
    rc = CATDocumentServices::OpenDocument(CAAUdfModelDocName.ConvertToChar(), pCAAUdfModel);

    if (FAILED(rc))
    {
        cout << "ERROR in opening the document= " << CAAUdfModelDocName.ConvertToChar() << endl;
        return 1;
    }
    else
    {
        cout << "   " << CAAUdfModelDocName.ConvertToChar() << " is the document into which";
    ...
    rc = CATDocumentServices::OpenDocument(CAAUdfLoftDocName.ConvertToChar(), pCAAUdfLoft);

    if (FAILED(rc))
    {
        cout << "ERROR in opening the document= " << CAAUdfLoftDocName.ConvertToChar() << endl;
        return 1;
    }
    else
    {
        ...
        cout << "   " << CAAUdfLoftDocName.ConvertToChar();
        ...
        (NULL_var != (*pListUserFeature)[1]))
    {
        ...
        if (SUCCEEDED(rc))
        {
            ...
            cout << (spAlias->GetAlias()).ConvertToChar() << endl << endl;
    ...
    {
        cout << "The " << CAAUdfLoftDocName.ConvertToChar();
    ...
    cout << (spAliasForFirstInput1->GetAlias()).ConvertToChar() << endl;
    cout << "       value of " << (*pListOfInputRole)[2].ConvertToChar() << " = ";
    cout << (spAliasForSecondInput1->GetAlias()).ConvertToChar() << endl << endl;
    ...
    cout << "      After SetNewInput, the first instance has 2 inputs:" << endl;
    cout << "       value of " << (*pListOfInputRole)[1].ConvertToChar() << " = ";
    cout << (spAliasForFirstInput2->GetAlias()).ConvertToChar() << endl;
    cout << "       value of " << (*pListOfInputRole)[2].ConvertToChar() << " = ";
    cout << (spAliasForSecondInput2->GetAlias()).ConvertToChar() << endl << endl;
        ...
        if (2 == nbparam)
        {
            ...
            for (int i = 1; i <= 2; i++)
            {
                ...
                if (NULL_var != spCkeParm)
                {
                    ...
                    cout << " its old value=" << oldvalue.ConvertToChar();

                    // Valuate is in MKS unit
                    spCkeParm->Valuate(i*0.010f);
                    CATUnicodeString newvalue = spCkeParm->Show();
                    cout << " and the new value=" << newvalue.ConvertToChar() << endl;
                }
                else
                {
    ...
    // @CSC-Filter UNER
    rc = CATDocumentServices::SaveAs(*pCAAUdfModel, DocumentSaveName.ConvertToChar());
    if (S_OK == rc)
    {
        cout << "   The " << DocumentSaveName.ConvertToChar() << " document with the 2 instantiations is saved" << endl;
    }
    else
    {
        cout << "ERROR in saving document " << DocumentSaveName.ConvertToChar() << endl;
        return 1;
    }
    ...
    if (FAILED(rc))
    {
        cout << "ERROR in closing document " << CAAUdfModelDocName.ConvertToChar() << endl;
        return 1;
    }
    pCAAUdfModel = NULL;
    ...
    if (FAILED(rc))
    {
        cout << "ERROR in closing document " << CAAUdfLoftDocName.ConvertToChar() << endl;
        return 1;
    }
    pCAAUdfLoft = NULL;
