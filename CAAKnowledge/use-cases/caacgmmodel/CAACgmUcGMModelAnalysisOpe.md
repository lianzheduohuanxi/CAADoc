...
![Use Case Data](images/CAACgmGMAnalysis.gif) | This use case creates the input data to be passed to the CATICGMLocalAnalysis1D operator (a circle with a radius of 50mm), creates the operator and performs the geometric analyzes. The result can be optionally saved into an NCGM container and displayed using the CAAGMModelGemBrowser use case [3].  
---|---  
