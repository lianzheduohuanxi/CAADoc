...
CAAGMModelAttributeRead.m (V6) | Read an attribute. |  [Reading an Attribute](CAACgmUcGobAttRead.md)  
CAAGMModelBodyFromLengthOnWire.m |  Create a topological point (CATBody) at some length along a wire (CATWire). |  [ Creating a Topological Point on a Wire at a Given Length from a Vertex](CAACgmUcTopGMModelPtOnWire.md)  
CAAGMModelComputePointOnWire.m | Compute a mathematical point (CATMathPoint) on a wire (CATBody). Input parameter is a curvilinear ratio. |  [Compute a Point on a Wire](CAACgmUcBtoPointOnWire.md)  
CAAGMModelConeCreation.m | Create a Frustum of a Right Circular Cone |  [Creating a Cone](CAACgmUcConeCreation.md)  
CAAGMModelConfusionOpe.m | Check the confusion of points. |  [Checking the Confusion of Points on a Curve](CAACgmUcGMModelConfusionPtCrvOpe.md) - [Checking the Confusion of Points on a Surface](CAACgmUcGMModelConfusionPtSurOpe.md)  
CAAGMModelConvertCurveToC2.m | Break a C1 curve into C2 pieces. |  [Breaking a C2 Curve into C2 Pieces](CAACgmUcTopGMModelCurveC1ToC2.md)  
CAAGMModelConvertSurfaceToC2.m | Break a C1 surface into C2 pieces. |  [Breaking a C1 Surface into C2 Pieces.](CAACgmUcTopGMModelSurfaceC1ToC2.md)  
...
CAAGMModelIntersect.m |  Intersect a curve with a surface. |  [Intersecting a Curve with a Surface](CAACgmUcGopIntersect.md)  
CAAGMModelIntersectionOpe.m |  Intersect a curve with a surface, a surface with a surface, a curve with a curve. |  [IntersectIng a Curve and a Surface](CAACgmUcIntersectCrvSur.md), [ Intersecting Surfaces](CAACgmUcIntersectSurSur.md), [ Intersecting Curves](CAACgmUcIntersectCrvCrv.md)  
CAAGMModelLifeCycleImplicit.m (V6) | Explain the life cycle of implicit objects. |  [Creating Implicit Objects](CAACgmUcGobLifeCycleImplicit.md)  
CAAGMModelLifeCycleExplicit.m (V6) | Explain the life cycle of explicit objects. |  [Creating Explicit Objects](CAACgmUcGobLifeCycleExplicit.md)  
CAAGMModelMakeLaws.m (V6) | Create composite laws. |  [Creating a Composite Law](CAACgmUcCompositeLaw.md)  
CAAGMModelNurbs.m (V6) | Create Nurbs. |  [Using Nurbs](CAACgmUcGobNurbs.md)  
CAAGMModelPositionOpe.m |  Determine the position of a point in a face or a volume. |  [Testing the Inclusion of a Point in a Volume or a Face.](CAACgmUcPtPosition.md)  
CAAGMModelProjectionOpe.m | Project a point onto a surface, a curve onto a surface, a point onto a curve. |  [Projecting a Point onto a Surface](CAACgmUcProjPtSur.md), [Projecting a Point onto a Curve](CAACgmUcProjPtCrv.md), [Projecting a Curve onto a Surface](CAACgmUcProjCrvSur.md)  
CAAGMModelSmartDuplicator.m (V6) | Remove a face from a skin by using the smart duplicator. |  [Using the Smart Duplicator](CAACgmUcTobSmartDuplicator.md)  
CAAGMModelSphereCreation.m (V6) | Create a Sphere |  [Creating a Sphere](CAACgmUcSphereCreation.md)  
CAAGMModelScanEdgeCurve.m (V6) | Scan an edge curve. |  [Scanning an Edge Curve](CAACgmUcTobEdgeCurve.md)  
...
CAAGMModelTetra.m | Use topological objects. |  [Using Topological Objects](CAACgmUcTobTetra.md)  
