...
source_file: "Doc/online/CAACgmModel/CAACgmUcMultiProc.htmmd"
...
Go to [Introduction to Multiprocessing](CAACgmTaMultiProcIntro.md) for more information on the MProc classes and principles. References [1] |  [ Building and Launching a Use Case](../CAADocUseCases/CAADocRunSample.md)

[2] |  [About Geometric Modeler Use Cases](../CAACgmModel/CAACgmUcGMUseCases.md)
[3] |  [Introduction to Multiprocessing](CAACgmTaMultiProcIntro.md)
3. Run the parallel transactions.
Go to [Introduction to Multiprocessing](CAACgmTaMultiProcIntro.md) for more information on the MProc classes and principles. References [1] |  [ Building and Launching a Use Case](../CAADocUseCases/CAADocRunSample.md)
