...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAScdStrWeldInfo02", "CAAScdInfUseCases", "CAAStrWeldInfoOnMembers", "CAAStrWeldInfoOnMembersSource", "CATIASfmMember", "CAAScdStrUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdStrUseCases/CAAStrWeldInfoOnMembers.htm"
converted: "2026-05-11T11:06:32.520383"
---
...
[]This macro shows you how to retrieve Weld information already set on SDD Member Objects.
		...
		![Starting Part](images/CAAScdStrWeldInfo02.png)
...
[]CAAStrWeldInfoOnMembers is launched in CATIA [[1]]. 
		Some documents are needed.
		

			
- [
				CAAStrWeldInfoOnMembers.CATScript] 
...
- [Retrieving SfmMember object from the reference 
				of Split Member]
			
- [Retrieving Super Plate which is used as Support 
				for Member]
...
This step describes how to get the SfmStiffener 
		object from Reference of split stiffener.****
...
This step describes how to get the Plate used as one 
of the limit for Member and accessing each element in it.
