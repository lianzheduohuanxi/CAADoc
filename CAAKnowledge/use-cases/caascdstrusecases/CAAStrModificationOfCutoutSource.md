...
Set
 CutoutToEdit = selection1.Item(1).Value
...
Set
 CurrentContour = CutoutToEdit.Contour
...
Set
 CurrentDirElement = CutoutToEdit.DirectionElement
...
Set
 partDocument1 = documents1.Item("Grid.CATPart")

Set
 part1 = partDocument1.Part

Set
 Newdir = part1.FindObjectByName("Sketch.4")

Set
 NewDirElement = part1.CreateReferenceFromObject(Newdir)
...
Set
 NewContour = rootProduct.CreateReferenceFromName("Product1/Grid/!Sketch.2")
