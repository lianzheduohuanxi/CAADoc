...
tags: ["CAAScrBase", "CAAScdStrWeldInfo03", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAStrWeldInfoOnPlateSource", "CAAStrWeldInfoOnPlate", "CAAScdStrUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdStrUseCases/CAAStrWeldInfoOnPlate.htm"
converted: "2026-05-11T11:06:32.516320"
---
...
[]This macro shows you how to retrieve Weld information already set on SDD Plate Objects.
		

		![Starting Product](images/CAAScdStrWeldInfo03.png)
...
[]CAAStrWeldInfoOnPlate is launched in CATIA [[1]]. 
		Some documents are needed.
		

			
- [
				CAAStrWeldInfoOnPlate.CATScript] 
...
Set 
SuperPlate2 = SuperPlates.Item(2)
```
...
Dim 
OperatedSplitPlateRefs
 As 
SfmSplitPlates

Set 
OperatedSplitPlateRefs = SuperPlate2.SplitPlatesObjects
...
Set 
OperatedSplitPlate = OperatedSplitPlateRefs.Item(1)
```

OperatedSplitPlate is the split plate on which weld features are created. Weld information resides on this plate.

OperatingSplitPlate is the split plate which is used as one of the limit of the OperatedSplitPlate.
...
Set 
ListWeldsUC1 = OperatedSplitPlate.GetWelds(OperatingSplitPlate)
...
Set 
WeldUC1Feature = ListWeldsUC1.Item(1)
```
...
Set 
ListWeldsUC2 = OperatedSplitPlate.GetWelds(Nothing)
...
Set 
WeldUC2Feature = ListWeldsUC2.Item(1)
```
