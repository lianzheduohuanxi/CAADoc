...
source_file: "Doc/online/CAACenQuickRefs/CAACenV5R18SP2NewCPPAPI.md"
...
The following are the new CAA V5R18 SP2 C++ Authorized APIs, compared with CAA V5R18 at SP1 level.
  ...
  * GeometricObjects framework
    ...
    * Macro or #define CATContextualGeometricFeatureType
    * Macro or #define CATDatumGeometricFeatureType
    * Macro or #define CATGeometricFeatureType
    * Macro or #define CATJointFilletType
    * Macro or #define CATProceduralGeometricFeatureType
