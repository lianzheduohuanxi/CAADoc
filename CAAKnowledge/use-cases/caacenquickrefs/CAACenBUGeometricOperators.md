...
CATCurve* iCrv2,  
CATSkillValue iMode = BASIC) |  Not supported any longer.  
**6 replacing methods** | Frameworks | Classes or Interfaces | Methods  
---|---|---  
...
CATSoftwareConfiguration* iConfig,  
CATCurve*iCurve1,  
CATCurve*iCurve2) |  Not supported any longer.  
...
CATAngle iAngle=0.,  
CATSkillValue mode=BASIC) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
...
double iTolerance) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
...
CATSoftwareConfiguration* iSoftwareConfig) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
GMModelInterfaces | Global function | CATCGMDynCreateMassProperties1D  
...
const double*iWeights) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
...
CATSoftwareConfiguration* iConfig,  
CATCurve* iCurve) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
...
CATSoftwareConfiguration* iConfig,  
CATSurface* iSurface) |  Not supported any longer.  
**1 replacing method** | Framework | Class or Interface | Method  
---|---|---  
