...
The following are the new CAA V5-6R2017 GA C++ Authorized APIs, compared with CAA V5-6R2016 at GA level.
  ...
  * GMModelCmpInterfaces framework
    ...
    * Class CATFeatureInfoPocket
    * Class CATFeatureInfoSlotRectangular
    * Class CATFeatureInfoSlotRounded
    * Class CATFeatureInfoSlot
    * Class CATFeatureTypeLogo
    * Class CATFeatureTypeNotch
    * Class CATFeatureTypePad
