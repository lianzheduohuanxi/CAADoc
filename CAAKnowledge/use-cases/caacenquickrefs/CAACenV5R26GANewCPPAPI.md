...
The following are the new CAA V5-6R2016 GA C++ Authorized APIs, compared with CAA V5-6R2015 at GA level.
  ...
  * GMModelCmpInterfaces framework 
    ...
    * Class CATFeatureInfoFilletVariableRadius
    * Class CATFeatureInfoFillet
    * Class CATFeatureInfoHoleCounterbored
    * Class CATFeatureInfoHoleCounterdrilled
    * Class CATFeatureInfoHoleCountersunk
    * Class CATFeatureInfoHoleSimple
    * Class CATFeatureInfoHole
    * Class CATFeatureInfo
    * Class CATFeatureIterator
    * Class CATFeatureTypeFillet
    * Class CATFeatureTypeHole
    * Class CATFeatureType
    * Class CATFeatureTypes
    * Class CATFeature
