...
You will find below: 
  ...
  * the Dialog framework class tree
  * the definition for all the Dialog Framework classes, illustrated whenever possible. To have a complete description of the classes interface, refer to the [Dialog Class Catalog](../CAADlgQuickRefs/CAADlgObjectList.htm).
...
All these classes derive from the abstract class `[CATDialog](../CAADlgQuickRefs/CAADlgCATDialog.htm)` which includes methods to define their common behavior and attributes. These include: 
...
The containers are used to contain several dialog components and to handle them as a whole, for example for layout purposes. They can be classified in: 
  ...
  * Windows deriving from the abstract class [CATDlgWindow](../CAADlgQuickRefs/CAADlgCATDlgWindow.htm)
  * Boxes deriving from the abstract class [CATDlgBox](../CAADlgQuickRefs/CAADlgCATDlgBox.htm). They are used to contain several Dialog framework objects
  * Bars deriving from the abstract class [CATDlgBar](../CAADlgQuickRefs/CAADlgCATDlgBar.htm)
  * Menus deriving from the abstract class [CATDlgMenu](../CAADlgQuickRefs/CAADlgCATDlgMenu.htm)
...
The windows are the primary containers which contain either other containers and components. They can be moved and resized. They include: 
  ...
  * The document window: class [CATDlgDocument](../CAADlgQuickRefs/CAADlgCATDlgDocument.htm)
...
The bars allow to gather a set of controls without needing to arrange them. Controls appear in their instantiation order. They include: 
  ...
  * The tool bar: class [CATDlgToolBar](../CAADlgQuickRefs/CAADlgCATDlgToolBar.htm)
...
The tool bar is designed to gather the tools of application. These tools are commands represented usually using icons, and are also usually available from pull-down menus.
  ...
  * The status bar: class [CATDlgStatusBar](../CAADlgQuickRefs/CAADlgCATDlgStatusBar.htm)
...
The menus gather in a small area the actions that are offered to the user. They are fully displayed on request only and save space for other purposes. They include: 
  ...
  * The menu bar: class [CATDlgMenu](../CAADlgQuickRefs/CAADlgCATDlgMenu.htm) ![CATDlgMenuBar.jpg \(2728 bytes\)](images/CATDlgMenuBar.jpg)
...
They are used to name some controls or containers and to help to layout windows. They include: 
  ...
  * The separator: class [CATDlgSeparator](../CAADlgQuickRefs/CAADlgCATDlgSeparator.htm) ![CATDlgSeparator.gif \(8487 bytes\)](images/CATDlgSeparator.gif)
...
The separator is used to leave thin vertical or horizontal empty areas between different Dialog framework objects to help better visualize the different parts of a window or box.
  ...
  * The label: class [CATDlgLabel](../CAADlgQuickRefs/CAADlgCATDlgLabel.htm) ![CATDlgLabel.gif \(14046 bytes\)](images/CATDlgLabel.gif) | The label is used to add an information text to controls and to other objects as well, such as frames. This text can be parametrized with data coming from the application.  
---|---  
...
The push button: class [CATDlgPushButton](../CAADlgQuickRefs/CAADlgCATDlgPushButton.htm)

![CATDlgPushButton.gif \(22816 bytes\)](images/CATDlgPushButton.gif) | The push button is the only control dedicated to execute an action, such as trigger a command, display help, cancel or quit the window. Use the push button whenever you want to execute an action as soon as the user has pushed on the push button.  
---|---  
...
These controls allow to key in or to enter a text or a value, or to select a value from a proposed list. 
  ...
  * The selector list: class [CATDlgSelectorList](../CAADlgQuickRefs/CAADlgCATDlgSelectorList.htm)
...
Use the selector list when you propose to the end user a choice among a list, or possibly several choices.
  ...
  * The combo: class [CATDlgCombo](../CAADlgQuickRefs/CAADlgCATDlgCombo.htm) 
...
[1] | [Designing Your Interactive Application](CAADlgInteractiveApplication.htm)  
---|---  
[2] | [Creating Dialog Objects](CAADlgCreatingDialogs.htm)  
[3] | [Assigning Resources to a Dialog Box](CAADlgResources.htm)  
[4] | [Arranging Dialog Objects](CAADlgObjectLayout.htm)  
[Top]  
