...
Most of the dialog classes can be used as is, that is instantiated, such as the controls, or the containers. Some others must be derived to create specialized objects, such as the dialog windows. Each class has a constructor which requires at least two parameters, and sometimes three: 
  ...
  1. **The parent** [1]. It is altogether: 
     * The parent in the dialog object containment structure. It is the container object. Some rules exist on the parent object. For example, a control cannot be a parent object, since it cannot contain other dialog objects. A [ CATDlgTabContainer](../CAADlgQuickRefs/CAADlgCATDlgTabContainer.htm) instance can contain only [ CATDlgTabPage](../CAADlgQuickRefs/CAADlgCATDlgTabPage.htm) instances, and conversely, a [ CATDlgTabPage](../CAADlgQuickRefs/CAADlgCATDlgTabPage.htm) instance can only be contained by [ CATDlgTabContainer](../CAADlgQuickRefs/CAADlgCATDlgTabContainer.htm), but can contain in turn other containers, such as [CATDlgFrame](../CAADlgQuickRefs/CAADlgCATDlgFrame.htm) instances, and controls.
     * The parent in the command tree structure. Since [CATDialog](../CAADlgQuickRefs/CAADlgCATDialog.htm) derives from _CATCommand_ , each dialog object instance is seen as a command for the event management mechanisms, such as the send/receive [2] and the callback [3] mechanisms.
...
As an example, the construction of a _[CATDlgCombo](../CAADlgQuickRefs/CAADlgCATDlgCombo.htm)_ instance could be as follows:
...
---|---|---  
Radio buttons |  ![Disable1.jpg \(1404 bytes\)](images/Disable1.jpg) |  ![Enable1.jpg \(1742 bytes\)](images/Enable1.jpg)  
Combo |  ![Disable2.jpg \(1875 bytes\)](images/Disable2.jpg) |  ![Enable2.jpg \(2049 bytes\)](images/Enable2.jpg)  
Menu items |  ![Disable3.jpg \(4214 bytes\)](images/Disable3.jpg) |  ![Enable3.jpg \(4415 bytes\)](images/Enable3.jpg)  
Push items |  ![Disable4.jpg \(1229 bytes\)](images/Disable4.jpg) |  ![Enable4.jpg \(1529 bytes\)](images/Enable4.jpg)  
...
[1] | [Dialog Class Usage and Link Reference](../CAADlgQuickRefs/CAADlgDialogSummary.htm)  
---|---  
[2] |  [ The Send/Receive Communication Protocol](../CAASysTechArticles/CAASysSendReceive.htm)  
[3] |  [ The Callback Mechanism](../CAASysTechArticles/CAASysCallbacks.htm)  
[4] | [Designing Your Interactive Application](CAADlgInteractiveApplication.htm)  
[5] | [Assigning Resources](CAADlgResources.htm)  
[Top]  
