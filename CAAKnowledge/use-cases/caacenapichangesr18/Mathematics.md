...
**Entity|  SP| Modification| To Do** | Mathematics/Public/CATTolerance.h/CATTolerance/GetResolution  
...
**Prototype:**`void SetScale(double iScale);`| 6| [ INDM](CAACenAPIChangeDetail.htm#Abstract)| Exposition error, should not be used. Check that you don't use it  
