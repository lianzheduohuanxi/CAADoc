...
tags: ["CAASmiTechArticles", "CAAStep", "CAADocStyleSheets", "CAASurfaceMachiningItf", "CAAOffset", "CATIMfgMachiningFeature", "CAASmiOperationSampleOverview", "CAAToolAngle", "CAASmiUserOperationCatalog", "CAASmgOperationWithMASU", "CAAUserOperationCatalog", "CAADocRunSample", "CATIM3xFeature", "CAADocUseCases", "CAAISmiUserMachFeature", "CAASmgOperationWithMA", "CAAApproachDistance", "CAASmgOperationSU", "CAASmgOperation", "CAASmiUserOperationUI"]
source_file: "Doc/online/CAASmiUseCases/CAASmiUserOperationCatalog.htm"
converted: "2026-05-11T11:06:32.969965"
---
...
### 
 ...
 StartUp. This step is the preliminary one for all NC Operation creation.
...
- [How to Launch CAASmiUserOperation][Catalog]
...
$ rm 
OS_directory
//resources/graphic/CAAUserOperationCatalog.CATfct

$ # Create empty catalog in the runtime view and empty osm (the absolute path for the catalog is MANDATORY)$
$ 
CATfctEditorAssistant -create-new-catalog -catalog-name $PWDb>/
OS_directory
/r/resources/graphic/CAAUserOperationCatalog.CATfct
