...
tags: ["CAADlgBBEditorMessage", "CATImplementClass", "CAADlgBBReceiverWindow", "CAASysTechArticles", "CAADlgBBEditorMessageHandler", "CATICommMsg", "CAADocStyleSheets", "CAADlgBBSenderWindow", "CAASysSampleBBSendRecSimpleMsg", "CAADlgBBReceiver", "CATIMessageReceiver", "CAADocRunSample", "CAADlgBBMessageNotification", "CAADlgBBSender", "CAADocUseCases", "CAASysUseCases", "CAASysSampleBBSendRecDataMsg", "CAASysSampleBBSimpleMsg", "CAADlgBBMessage", "CATInstantiateComponent"]
source_file: "Doc/online/CAADlgUseCases/CAADlgSampleBBMsg.htm"
converted: "2026-05-11T11:06:32.995856"
---
...
This article shows how to make two interactive applications
...
- [**The CAADlgBBSender and CAADlgBBReceiver
 Use Cases**]
...
- [Where to Find the CAADlgBBSender and
 CAADlgBBReceiver Code]
...
message is printed.
 ...
 |![](images/CAADlgBBSender.jpg)
 |![](images/CAADlgBBReceiver.jpg)
...
CAADialog.edu framework:
 ...
 |Windows
 |`InstallRootDirectory\CAADialog.edu\CAADlgBBSender.m\
...
(Line.CastToCharPtr());
 ...
 rc = pIDataRequest->QueryInterface(
IID_CATICommMsg
,(void**)&pICommMsg);
 ...
 rc = _pICommunicator->
SendRequest
(ReceiverApplicationId, pICommMsg);
 pICommMsg->Release();
 pICommMsg = NULL;
 }
...
void CAADlgBBEditorMessageHandler::
HandleMessage
(CATICommMsg* iMessage)
{
 if ( NULL != iMessage )
 {
 ...
 CAADlgBBMessageManager * pManager = CAADlgBBMessageManager::
GetManager
();
 pManager->
EventToDispatch
...
void CAADlgBBMessageManager::
EventToDispatch
(char * iText)
{
 CATCallbackManager * pCBManager = ::
...
();
 ...
 _pMessageManager = CAADlgBBMessageManager::
GetManager
();
 ::
AddCallback
...
global function whose arguments are:
 ...
 |`CAADlgBBMessageNotification`
 |The event to subscribe. It is the class name of the notification that is
 sent by the message manager
 ...
 ************************
```
HRESULT CAADlgBBReceiverWindow::
BackboneInit
()
{
 HRESULT rc = E_FAIL;
...
( ReceiverApplicationId );
 ...
 pHandlerForMessage = new 
CAADlgBBEditorMessageHandler
();

 if ( NULL != pHandlerForMessage )
 {
 rc = pHandlerForMessage->QueryInterface(
IID_CATIMessageReceiver
,
...
### []References
 ...
 |[6]
 |[Object
 Modeler Component and Implementation Inheritances]
