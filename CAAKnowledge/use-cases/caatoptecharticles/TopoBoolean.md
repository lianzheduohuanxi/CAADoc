...
Fig. 1: The Difference Operator ![Boolean1.gif \(3659 bytes\)](images/Boolean1.gif) | Fig. 1 illustrates the way Boolean operators proceed, by taking the example of the difference operator. The specificity of each operator are taken into account during the second step: 
...
Fig. 3: Use a different object for the same result ![Boolean3.gif \(6766 bytes\)](images/Boolean3.gif) |  In the first example, operating with a bigger B object leads to suppress the overlap.   In the second example, B is taken smaller to suppress the overlap.   In the last example, a bigger B again leads to suppress the overlap.  
---|---  
...
Fig. 8 : Definition of a Pad "Until" ![Boolean5.gif \(3171 bytes\)](images/Boolean5.gif) | The Case "b" is a better way to proceed: it allows you to give a logical information to the prism operator, that is used to avoid useless computations.  
---|---  
