...
tags: ["CAAScrBase", "CAADriSetPrintArea", "CAAInfLauchMacro", "CAADriObjDrawingView", "CAAScdInfUseCases", "CAAScdDriTechArticles", "CAADriISetPrintArea", "CAADriObjDrawingSheet", "CAADriSetPrintAreaSource", "CATIADrawingView", "CAADriObjDrawingDocument", "CAAlink", "CAADriUseCases", "CAADriObjDrawingSheets", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdDriUseCases/CAADriSetPrintArea.htm"
converted: "2026-05-11T11:06:32.923950"
---
...
---
 ...
 |This macro shows you how to set the print area of the current sheet
 ...
 sheet, including those into a view.

 This macro is based on an active drawing document.
 
 
 |![](../CAAScrBase/images/ainfo.gif)
 |Open the drawing document: [CAADriSetPrintArea.CATDrawing]
 

[]Run CAADriISetPrintArea in CATIA [[1]].
 

[CAADriISetPrintArea] is
...
If 
TypeName(oDocument) = "DrawingDocument" Then
...
MsgBox
 "This macro can be run with a drawing document only."
...
oSheet 
=
 oDrawingDocument.Sheets.ActiveSheet 
...
```
...
ReturnStatus 
= 
oSelection.IndicateOrSelectElement2D("Select the first point", _
...
ObjectSelected = True
 ...
 Set 
iFirstPoint = oSelection.Item(1).Value
 ...

 Set 
oView = oSelection.FindObject("CATIADrawingView")
 ...
...
If 
oFirstPointAbsolute(0) > oSecondPointAbsolute(0)
 Then
...
If 
oFirstPointAbsolute(1) > oSecondPointAbsolute(1)
 Then
