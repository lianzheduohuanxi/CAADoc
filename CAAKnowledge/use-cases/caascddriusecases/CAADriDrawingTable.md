...
tags: ["CAAScrBase", "CAADriDrawingTableSource", "CAAInfLauchMacro", "CAADriObjDrawingView", "CAAScdInfUseCases", "CAAScdDriTechArticles", "CAADriObjDrawingSheet", "CAADriObjDrawingSheets", "CAADriDrawingtable", "CAADriObjDrawingDocument", "CAADriUseCases", "CAADriDrawingTable", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdDriUseCases/CAADriDrawingTable.htm"
converted: "2026-05-11T11:06:32.928047"
---
...
This macro shows you how to create a drawing table in Drawing document.
 
 

This macro creates a new drawing document. In the active view of the
...
[]CAADriDrawingTable is launched in CATIA [[1]].
 No open document is needed.
 

 

[CAADriDrawingTable.CATScript]
...
' Create a new drawing document
 ...
 Set 
oDrwDocument = CATIA.Documents.Add("Drawing")
...
' Retrieve the drawing document's sheets collection
 ...
 Set 
oDrwSheets = oDrwDocument.Sheets
...
' Create a new drawing table
 ...
 Set 
oDrwTable = oDrwTables.Add(107, 70, 9, 9, 5, 20)
```
