...
tags: ["CAAScdDriUseCases", "CAAScrBase", "CAAInfLauchMacro", "CAADriObjDrawingView", "CAADriInstantiateInnerDitto", "CAAScdInfUseCases", "CAADriInstantiateInnerDittoSource", "CAAScdDriTechArticles", "CAADriObjDrawingSheet", "CAADriObjDrawingDocument", "CAADriInstantiateDittoSource", "CAADriUseCases", "CAADriObjDrawingSheets", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdDriUseCases/CAADriInstantiateInnerDitto.htm"
converted: "2026-05-11T11:06:32.890401"
---
...
---
 ...
 |[] CAADriInstantiateInnerDitto is
 launched in CATIA [[1]]. No open document is
 needed.
 

[CAADriInstantiateInnerDitto]
...
DrawingDocument
 ...
 Set 
oDrawing = CATIA.Documents.Open(sDocPath & _
...
DrawingView
 ...
 Set 
oView = oSheet.Views.Item("View.3")
 oView.Activate
 ...
```
...
DrawingSheet
 ...
 Set 
oDetailSheet = oSheets.Item("Sheet.2 (Detail)")
...
DrawingView
 ...
 Set 
oDetailView = oDetailSheet.Views.Item("DrwDetail.1")
 ...
```
...
DrawingComponents
 ...
 Set 
o2DComponents = oView.Components
...
DrawingComponent
 ...
 Set 
o2DComponent = o2DComponents.Add(oDetailView, iDittoCoordinates(0), iDittoCoordinates(1))
 ...
```
