...
tags: ["CATIADrawingView", "CAAScrBase", "CAADriSetPrintArea", "CATIA"]
source_file: "Doc/online/CAAScdDriUseCases/CAADriSetPrintAreaSource.htm"
converted: "2026-05-11T11:06:32.910771"
---
...
Dim 
oFirstPointRelative(1)

Dim 
oFirstPointAbsolute(1)

' Retrieve the first point location to set the print area from the mouse selection

ReturnStatus 
= 
oSelection.IndicateOrSelectElement2D("Select the first point", InputObjectType, True, True, False, ObjectSelected, oFirstPointAbsolute)
...
Dim 
oSecondPointRelative(1)

Dim 
oSecondPointAbsolute(1)
...
' Retrieve the drawing point object
 ...
 Set 
iSecondPoint = oSelection.Item(1).Value
...
Private Sub
 CatAbsoluteCoordinates(CatDrawingView
 As 
Object, AbsoluteCoordinates(), RelativeCoordinates())
