...
![](../CAAScrBase/images/atarget.gif) |  This macro shows you how to create a pad from a sketch. This macro opens the [CAAPriPad.CATPart](samples/CAAPriPad.CATPart) document that contains a sketch only.   
It creates _Pad_ object from a _Sketch_ __ object with a _ShapeFactory_ method and a update it.  
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAPriPad is launched in CATIA [1]. No open document is needed. [CAAPriPad.CATScript](CAAPriPadSource.htm) is located in the CAAScdPriUseCases module. [Execute macro](macros/CAAPriPad.CATScript) (windows only).    
