...
Purpose This page is intended for developers and people getting started with [mkmk](CAABtlMANMkmk.htm) and [related tools](CAABtlMANMkThemIx.htm). The reader will find here how to set up his environment to access commands and a brief description on the most useful commands and topics. Note that all commands or options are not given here, please refer to the [manual pages](CAABtlMANMkThemIx.htm) to get them. We advice you to add a bookmark to this page or to print it.  
...
_`[mkmk](CAABtlMANMkmk.htm)`_ or _`cd ws_root_dir`_  
...
[.mk](../CAABtlTechArticles/CAABtlMANimakefile.htm) | framework/module.m/ | Template for [mkmk](CAABtlMANMkmk.htm) and specifying what to produce from this module.  
