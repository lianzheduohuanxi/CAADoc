...
The commands to manage the frameworks are:
      * [mkCopyFw](CAABtlMkOthers.htm#mkCopyFW) to copy frameworks
      * [mkRmFw](CAABtlMkOthers.htm#mkRmFw) to delete frameworks into a workspace
      * [mkRemoveDo](CAABtlMkOthers.htm#mkRemoveDo) to delete derived objets
The commands to prepare a runtime environment are:
      * [mkCreateRuntimeView](CAABtlMkOthers.htm#mkCreateRuntimeView) to create a run time view
      * [mkrun](CAABtlMkOthers.htm#mkrun) to execute a CAA program.
[Top]
