...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshBasicSurf is launched in CATIA [1]. No open document is needed. [CAAAniMeshBasicSurf.catvbs](CAAAniMeshBasicSurfSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshBasicSurf.catvbs) (Windows only).  
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshBasicSurf includes the following steps:
