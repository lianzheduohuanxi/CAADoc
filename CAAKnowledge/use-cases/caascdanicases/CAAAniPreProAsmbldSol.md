...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniPreProAsmbldSol is launched in CATIA [1].No open document is needed. [CAAAniPreProAsmbldSol.catvbs](CAAAniPreProAsmbldSolSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniPreProAsmbldSol.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniPreProAsmbldSol includes the following steps:
