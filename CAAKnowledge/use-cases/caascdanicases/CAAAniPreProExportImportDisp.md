...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniPreProExportImportDisp is launched in CATIA [1]. No open document is needed. [ CAAAniPreProExportImportDisp.catvbs](CAAAniPreProExportImportDispSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniPreProExportImportDisp.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniPreProExportImportDisp includes the following steps:
