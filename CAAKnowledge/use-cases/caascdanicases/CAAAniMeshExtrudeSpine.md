...
![](../CAAScrBase/images/atarget.gif) |  This use case shows how to create a mesh part Extrude along a spine. This macro opens an Analysis document. Extrude along a spine mesh part can generate a 2D mesh from 1D mesh and 3D mesh from 2D mesh. In this macro 3D mesh from 2D surface mesh is created. Global specifications associated with the mesh part are set.   ![](images/ExtrAlongSpineMesh.gif)    
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshExtrudeSpine is launched in CATIA [1]. No open document is needed. [CAAAniMeshExtrudeSpine.catvbs](CAAAniMeshExtrudeSpineSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshExtrudeSpine.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshExtrudeSpine includes the following steps:
