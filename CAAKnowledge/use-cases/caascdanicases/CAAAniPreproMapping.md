...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAAAniPreproOnPublish is launched in CATIA [1]. No open document is needed. [CAAAniPreproMapping.catvbs](CAAAniPreproMappingSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniPreproMapping.catvbs) (Windows only).    
