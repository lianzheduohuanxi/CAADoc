...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshTetraFiller is launched in CATIA [1]. No open document is needed. [CAAAniMeshTetraFiller.catvbs](CAAAniMeshTetraFillerSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshTetraFiller.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshTetraFiller includes the following steps:
