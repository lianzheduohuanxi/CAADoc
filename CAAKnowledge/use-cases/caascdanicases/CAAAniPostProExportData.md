...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniPostProExportData is launched in CATIA [1]. No open document is needed. [ CAAAniPostProExportData](CAAAniPostProExportDataSource.htm) is located in the CAAScdAniUseCases module. **[Execute macro](macros/CAAAniPostProExportData.catvbs)** (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniPostProExportData includes the following steps:
