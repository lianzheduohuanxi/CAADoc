...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshSeamWelding is launched in CATIA [1]. No open document is needed. [CAAAniMeshSeamWelding.catvbs](CAAAniMeshSeamWeldingSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshSeamWelding.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshSeamWelding includes the following steps:
