...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAAAniPreproOnPublish is launched in CATIA [1]. No open document is needed. [CAAAniPreproOnPublish.catvbs](CAAAniPreproOnPublishSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniPreproOnPublish.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) | CAAAniPreproOnPublish includes the following steps: 
