...
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshSymmetry.md"
...
* * *
  ...
  This use case shows how to create a symmetry mesh part. Symmetry transformation can be applied to a 1D, 2D and 3D mesh. This scenario requires "FEM Surface (FMS)" product to create 1D or 2D transformed mesh part and FEM Solid (FMD) product to create 3D transformed mesh part. This macro opens an Analysis document. A symmetry mesh part is created on a Surface mesh part. The surface mesh part already exists in the document.   ![](images/SymmetryMesh.gif)    
---|---  
  CAAAniMeshSymmetry is launched in CATIA [1]. No open document is needed. [CAAAniMeshSymmetry.catvbs](CAAAniMeshSymmetrySource.md) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshSymmetry.catvbs) (Windows only).    
