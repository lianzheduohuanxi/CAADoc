...
![](../CAAScrBase/images/atarget.gif) |  This use case shows how to create a extrude with translation mesh parts.  This macro opens an Analysis document. Extrude with translation mesh part can create a 2D mesh from 1D mesh and 3D mesh from 2D mesh. In this macro 3D mesh from 2D mesh is created. Global specifications associated with the mesh part set.   ![](images/ExtrWithTransMesh.gif)    
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshExtrudeTrans is launched in CATIA [1]. No open document is needed. [CAAAniMeshExtrudeTrans.catvbs](CAAAniMeshExtrudeTransSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshExtrudeTrans.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshExtrudeTrans includes the following steps:
