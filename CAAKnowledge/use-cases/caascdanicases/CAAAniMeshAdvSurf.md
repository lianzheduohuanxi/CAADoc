...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshAdvSurf is launched in CATIA [1]. No open document is needed. [CAAAniMeshAdvSurf.catvbs](CAAAniMeshAdvSurfSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshAdvSurf.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshAdvSurf includes the following steps:
