...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAAniMeshSpotWelding is launched in CATIA [1]. No open document is needed. [CAAAniMeshSpotWelding.catvbs](CAAAniMeshSpotWeldingSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniMeshSpotWelding.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAAniMeshSpotWelding includes the following steps:
