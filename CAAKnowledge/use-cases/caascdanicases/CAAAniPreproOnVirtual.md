...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAAAniPreproOnVirtual is launched in CATIA [1]. No open document is needed. [CAAAniPreproOnVirtual.catvbs](CAAAniPreproOnVirtualSource.htm) is located in the CAAScdAniUseCases module. [Execute macro](macros/CAAAniPreproOnVirtual.catvbs) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) | CAAAniPreproOnVirtual includes the following steps: 

  1. Prolog
  2. Importing the Part Document
  3. Creating an Analysis Case for Frequency Analysis
  4. Creating Virtual Parts inside the Property Set
  5. Defining Boundaries on the Virtual Parts
  6. Defining Non Structural Masses
  7. Computing the Case
  8. Epilog
...
---|---  
[2] | [Physical types for structural analysis](../CAAScdAniTechArticles/CAAAniPreprocessingFeatures.htm)  
[Top]  
