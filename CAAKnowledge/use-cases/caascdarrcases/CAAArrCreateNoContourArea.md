...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAArrCreateNoContourArea is launched in CATIA [1]. No open document is needed. [CAAArrCreateNoContourArea.CATScript](CAAArrCreateNoContourAreaSource.htm) is located in the CAAScdArrUseCases module. [Execute macro](macros/CAAArrCreateNoContourArea.CATScript) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAArrCreateNoContourArea includes the following steps:
