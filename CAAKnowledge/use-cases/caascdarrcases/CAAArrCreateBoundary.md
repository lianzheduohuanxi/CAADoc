...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAArrCreateBoundary is launched in CATIA [1]. No open document is needed. [CAAArrCreateBoundary.CATScript ](CAAArrCreateBoundarySource.htm)is located in the CAAScdArrUseCases module. [Execute macro](macros/CAAArrCreateBoundary.CATScript) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAArrCreateBoundary includes the following steps:
