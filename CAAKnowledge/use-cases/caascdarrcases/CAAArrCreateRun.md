...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAAArrCreateRun is launched in CATIA [1]. No open document is needed. [CAAArrCreateRun.CATScript ](CAAArrCreateRunSource.htm)is located in the CAAScdArrUseCases module. [Execute macro](macros/CAAArrCreateRun.CATScript) (Windows only).    
![](../CAAScrBase/images/ascenari.gif) |  CAAArrCreateRun includes the following steps:
