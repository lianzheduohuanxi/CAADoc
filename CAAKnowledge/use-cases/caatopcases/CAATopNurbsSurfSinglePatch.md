...
For how to create a skin, see the [CAATopOverview](CAATopOverview.htm) use case[2]. You have to define the limits on which the skin is to be applied. In this use case, the maximum limits are specified.
