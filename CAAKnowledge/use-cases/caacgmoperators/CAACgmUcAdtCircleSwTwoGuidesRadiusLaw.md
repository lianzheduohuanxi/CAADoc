...
In Short This use case is an example of how to create a circle sweep with two guides and a radius law. References [1] | [Overview of the Topological Operators](CAACgmUcTopOverview.htm)  
---|---  
