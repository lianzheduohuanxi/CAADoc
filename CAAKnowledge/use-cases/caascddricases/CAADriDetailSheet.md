...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAADriSheet is launched in CATIA [1]. No open document is needed. [CAADriDetailSheet.CATScript](CAADriDetailSheetSource.htm) is located in the CAAScdPriUseCases module. [Execute macro](macros/CAADriDetailSheet.CATScript) (Windows only).    
