...
---|---  
![](../CAAScrBase/images/ainfo.gif) |  CAADriInstantiateOuterDitto is launched in CATIA [1]. No open document is needed. [CAADriInstantiateOuterDitto](CAADriInstantiateOuterDittoSource.htm) is located in the CAADriUseCases module.  [Execute macro](macros/CAADriInstantiateOuterDitto.CATScript) (Windows only).  
![](../CAAScrBase/images/ascenari.gif) | CAADriInstantiateOuterDitto includes nine steps: 
