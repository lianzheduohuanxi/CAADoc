...
source_file: "Doc/online/CAACenAPIChangesR23/CAACenAPIChangeDetail.htmmd"
converted: "2026-05-11T17:33:51.747195"
```
...
|
### Detail Of V5-6R2013 C++ API Changes
...
This article presents by frameworks the detail of CAA C++ resources modified in V5-6R2013 and how to modify your code accordingly. Each modification is listed for a resource (file, class, method) with a classification. They will generally be detected by a recompilation of the code. Most of the time, signature modifications are obvious. Check in the framework detail how to replace deleted entities. Possibly impacting modifications are highlighted in red.
...
_Copyright 2012, Dassault Systmes. All rights reserved._
