...
tags: ["CAAAniPreproOnPublish", "CAAScrBase", "CAAScdAniUseCases", "CATIA", "CATISamImportDefine"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniPreproOnPublishSource.htm"
converted: "2026-05-11T11:06:32.420674"
---
...
' Create corresponding image.
 ...
 Set 
analysisImages1 = analysisSet3.AnalysisImages

 Set 
analysisImage1 = analysisImages1.Add("StressVonMises_Iso_Smooth", False, False, True)
...
outputPath=CATIA.SystemService.Environ("CATTemp")
 ...
 If
(Not CATIA.FileSystem.FolderExists(outputPath)) 
Then
...
fileSystem1 = CATIA.FileSystem
 ...
 Set 
folder1 = fileSystem1.GetFolder(outputPath)
