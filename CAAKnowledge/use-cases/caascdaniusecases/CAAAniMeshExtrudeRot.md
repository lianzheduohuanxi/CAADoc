...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAAniMeshExtrudeRot", "CAAScdInfUseCases", "CAAAniTocAnalysisDocument", "CAAAniMeshExtrudeRotSource", "CAAScdAniTechArticles", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshExtrudeRot.htm"
converted: "2026-05-11T11:06:32.456202"
---
...
[]This use case shows how to create extrude with rotation 
		mesh part. 
		

This macro opens an Analysis document. Extrude with rotation mesh part 
		can create a 2D mesh from 1D mesh and 3D mesh from 2D mesh. In this macro 
		3D mesh from 2D mesh is created. Global specifications associated with the 
		mesh part are set.
...
[]CAAAniMeshExtrudeRot is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshExtrudeRot.catvbs] 
...
Set 
pubAxis = publications.Item("Axis")
...
Set 
extrudeMesh = oAnalysisMeshParts.Add("MSHPartExtrRotation")
