...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAAniPreprocessingFeatures", "CAAScdInfUseCases", "CAAAniTocAnalysisDocument", "CAAScdAniUseCases", "CAAScdAniTechArticles", "CAAAniPrepro", "CAAAniPreproSource", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniPrepro.htm"
converted: "2026-05-11T11:06:32.439615"
---
...
[]This macro shows you how to create preprocessing 
...
It opens an Analysis document, and generates preprocessing data applied 
		...
		and launches the solver in order to generate the finite element results.
		

		![](images/MacroPrepro.jpg)
...
[]CAAAniPrepro is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniPrepro.CATScript] is located 
...
- [Navigating into the Analysis Document in Order 
...
Set
 oAnalysisDocument = CATIA.Documents.Open
...
Set
 PartDocument = documents1.Item(3)
...
Set
 referenceBound = part1.CreateReferenceFromName("Selection_RSur:(Face:(Brp:(GSRotate.2...));None:());...)")
...
Set
 referenceLoad = part1.CreateReferenceFromName("Selection_RSur:(Face:(Brp:(GSMRotate.2...));None:());...)")
...
Set
 AnaManager = oAnalysisDocument.Analysis
...
Set
 AnaModels = AnaManager.AnalysisModels
...
Set
 MySet= ListSets.ItemByType("RestraintSet")
...
Set
 anEntities = MySet.AnalysisEntities
...
Set
 analysisEntity = anEntities.Add("SAMClamp")
...
Set
 MySet= ListSets.ItemByType("LoadSet")
...
Set
 analysisEntity = anEntities.Add("SAMMoment")
