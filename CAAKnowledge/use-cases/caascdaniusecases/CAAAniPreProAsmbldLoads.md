...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAScdInfUseCases", "CATIAAnalysisSet", "CAAAniPreProAsmbldLoads", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAAniPreProAsmbldLoadsSource", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniPreProAsmbldLoads.htm"
converted: "2026-05-11T11:06:32.330804"
---
...
This macro opens an analysis assembly document and creates an 
...
[]CAAAniPreProAsmbldLoads is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniPreProAsmbldLoads.catvbs]
...
Set 
analysisSet1 = analysisSets1.Item("Loads.1", catAnalysisSetSearchAll)
...
Set 
analysisEntity1 = analysisEntities1.Add("SAMLoadAssembly")
...
Set 
basicComponent1 = basicComponents1.GetItem("SAMLoadP.1")
...
```
...
Set 
analysisSet = selection1.FindObject("CATIAAnalysisSet")

Set 
entity = analysisSet.AnalysisEntities.Item(1)
 IF ( entity.Type = "SAMLoadAssembly") Then 'DO NOTHING
 ELSE 

 Set 
Reference =analysisManager2.CreateReferenceFromObject(analysisSet)
