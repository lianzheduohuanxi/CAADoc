...
tags: ["CAAScrBase", "CAAAniMeshTranslationSource", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAAniMeshTranslation", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshTranslation.htm"
converted: "2026-05-11T11:06:32.355823"
---
...
[]This use case shows how to create a translation mesh 
		part. A translation mesh can be created on 1D, 2D or 3D mesh part. This 
...
This macro opens an Analysis document. A translation mesh part is created 
		on a surface mesh part. The surface mesh part already exist in the document.
		

 
		

![](images/TranslationMesh.gif)
...
[]CAAAniMeshTranslation is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshTranslation.catvbs] 
