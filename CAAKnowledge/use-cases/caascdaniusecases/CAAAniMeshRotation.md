...
tags: ["CAAAniMeshRotationSource", "CAAScrBase", "CAAInfLauchMacro", "CAAAniMeshRotation", "CAAScdInfUseCases", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshRotation.htm"
converted: "2026-05-11T11:06:32.321896"
---
...
[]This use case shows how to create a rotation mesh 
		part. Rotation transformation can be applied to a 1D, 2D and 3D mesh. This 
...
This macro opens an Analysis document. A rotation mesh part is created 
...
[]CAAAniMeshRotation is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshRotation.catvbs] 
...
Set 
meshTrans = oAnalysisMeshParts.Add("MSHPartRotation")
...
This use case has shown how to create a rotation mesh part and how to assign 
