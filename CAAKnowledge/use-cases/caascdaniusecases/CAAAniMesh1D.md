...
tags: ["CAAScrBase", "CAAAniMesh1D", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAAniMesh1DSource", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMesh1D.htm"
converted: "2026-05-11T11:06:32.326922"
---
...
[]This use case shows how to create 1D mesh parts in 
		an existing analysis document. This scenario requires "FEM Surface (FMS)" 
		product.
		

This macro opens an Analysis document. It creates 1D (or beam) mesh part 
		and and sets global specifications associated with this mesh part. 
...
[CAAAniMesh1D.catvbs] is located 
		in the CAAScdAniUseCases module. [Execute 
		macro] (Windows only).
