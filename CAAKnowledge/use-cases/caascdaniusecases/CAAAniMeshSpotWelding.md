...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAAniTocAnalysisDocument", "CAAAniMeshSpotWeldingSource", "CAAScdAniTechArticles", "CAAAniMeshSpotWelding", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshSpotWelding.htm"
converted: "2026-05-11T11:06:32.312384"
---
...
[]This use case shows you how to create surface welding 
		connection mesh part. This scenario requires "FEM Surface (FMS)".
		

The macro opens an analysis document. Spot welding connection mesh can 
		...
		as support to the mesh part and it is updated to generate mesh.
		

![](images/SpotWeldingMesh.gif)
...
[]CAAAniMeshSpotWelding is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshSpotWelding.catvbs] 
