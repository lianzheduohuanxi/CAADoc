...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAScrJavaScript", "CAAAniMeshSeamWelding", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAScdAniUseCases", "CATIA", "CAAAniMeshSeamWeldingSource"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshSeamWelding.htm"
converted: "2026-05-11T11:06:32.351357"
---
...
[]This use case shows you how to create seam welding 
		connection mesh part. Seam weld can be defined as wire frame or 1D feature. 
		This scenario requires "FEM Surface (FMS)".
...
[]CAAAniMeshSeamWelding is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshSeamWelding.catvbs] 
...
Set 
seamWeld = oAnalysisMeshParts.Add ("MSHPartConnWeldSeam") 
