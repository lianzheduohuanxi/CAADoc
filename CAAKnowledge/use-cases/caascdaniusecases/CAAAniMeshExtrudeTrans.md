...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAAniMeshExtrudeTransSource", "CAAScdInfUseCases", "CAAAniMeshExtrudeTrans", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshExtrudeTrans.htm"
converted: "2026-05-11T11:06:32.397508"
---
...
[]This use case shows how to create a extrude with 
		translation mesh parts. 
		

This macro opens an Analysis document. Extrude with translation mesh 
		part can create a 2D mesh from 1D mesh and 3D mesh from 2D mesh. In this 
		macro 3D mesh from 2D mesh is created. Global specifications associated 
		with the mesh part set.
		

 
		

![](images/ExtrWithTransMesh.gif)
...
[]CAAAniMeshExtrudeTrans is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshExtrudeTrans.catvbs] 
...
Set 
extrudeMesh = oAnalysisMeshParts.Add("MSHPartExtrTranslation")
