...
tags: ["CAAScrBase", "CAAAniMeshCoating2DSource", "CAAInfLauchMacro", "CAAScdInfUseCases", "CAAAniMeshCoating1D", "CAAScdAniTechArticles", "CAAAniTocAnalysisDocument", "CAAAniMeshCoating2D", "CAAScdAniUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniMeshCoating2D.htm"
converted: "2026-05-11T11:06:32.287727"
---
...
[]This use case shows you how to create coating 2D 
...
[]CAAAniMeshCoating2D is launched in CATIA [[1]]. 
		No open document is needed.
		

[CAAAniMeshCoating2D.catvbs] 
...
Set 
pubFace = publications1.Item("Top")
...
Set 
oAnalysisMeshPart = oAnalysisMeshParts.Item(1)
```
...
Set 
coat2D = oAnalysisMeshPart.Add ("MSHPart2DCoating") 
