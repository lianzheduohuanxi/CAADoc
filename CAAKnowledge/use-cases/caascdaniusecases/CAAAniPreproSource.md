...
tags: ["CAAScrBase", "CAAScdAniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdAniUseCases/CAAAniPreproSource.htm"
converted: "2026-05-11T11:06:32.407815"
---
...
Document
 ...
 Set 
oAnalysisDocument = documents1.Open(sDocPath & "\online\CAAScdAniUseCases\samples\AnalysisCrank.CATAnalysis")
...
Reference
 ...
 Set 
referenceBound = part1.CreateReferenceFromName("Selection_RSur:(Face:(Brp:(GSMRotate.2;(Brp:(GSMTranslate.2;(Brp:(Shaft.2;0:(Brp:(Sketch.5;7)))))));None:());GSMRotate.2)")
...
Reference
 ...
 Set 
referenceLoad = part1.CreateReferenceFromName("Selection_RSur:(Face:(Brp:(GSMRotate.2;(Brp:(GSMTranslate.2;(Brp:(Shaft.1;0:(Brp:(Sketch.4;4)))))));None:());GSMRotate.2)")
