...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAPstPad1_1", "CAAPstPad1_2", "CAAScdInfUseCases", "CAAScdPstUseCases", "CAAPstAddNewProductSource", "CAAPstAddNewProduct", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdPstUseCases/CAAPstAddNewProduct.htm"
converted: "2026-05-11T11:06:32.490100"
---
...
[]This macro shows you how to create a simple product
 ...
 documents, CAAPstPad1_1.CATPart and CAAPstPad1_2.CATPart
 
 

The macro creates a new Product document and retrieves its root
 ...
 is repeated for a second new product.
 

Here is an image of the resulting product structure:
 
 
 |![](image/CAAPstAddNewProduct.jpg)
...
Set
 oRootProduct = oProductDoc.Product
...
Set
 oRootChildren = oRootProduct.Products 
 ...
```
...
Set
 oChildProduct2 = oRootChildren.AddNewProduct("Child_2_Type")
