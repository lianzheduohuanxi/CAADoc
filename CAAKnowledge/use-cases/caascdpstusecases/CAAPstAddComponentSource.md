...
tags: ["CAAPstHull", "CAAScrBase", "CAAPstAddComponent", "CAAPstFunnel", "CATIA"]
source_file: "Doc/online/CAAScdPstUseCases/CAAPstAddComponentSource.htm"
converted: "2026-05-11T11:06:32.494964"
---
...
Product
 ...
 Set 
 oHull = oTitanicProducts.AddNewProduct("Hull_Type")
...
Product
 ...
 Set 
oFunnel1 = oTitanicProducts.AddNewProduct("Funnel_Type")
...
Product
 ...
 Set 
oFunnel2 = oTitanicProducts.AddComponent(oFunnelRef)
...
Product
 ...
 Set 
oFunnel3 = oTitanicProducts.AddComponent(oFunnelRef)
...
Product
 ...
 Set 
oFunnel4 = oTitanicProducts.AddComponent(oFunnelRef)
