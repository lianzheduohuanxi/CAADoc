...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAAPriChangePatternSource", "CAAPriChangePattern02", "CAAScdInfUseCases", "CAAPriChangePattern01", "CAAPriPatternDescription", "CAAlink", "CAAPriChangePattern", "CAAPriChangePattern03", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdPriUseCases/CAAPriChangePattern.htm"
converted: "2026-05-11T11:06:32.837227"
---
...
---
 ...
 |[]This macro shows you how to change the description 
 of a pattern to the unequal spacing angular mode.
...
It modifies the *
 [
 CircPattern]* object from its methods and properties, and update the 
 part.
...
- []Open the
 [CAAPriChangePattern.CATPart] 
 document.
 
- Reference in the application the catscript file: 
 [CAAPriChangePattern.htm].
...
![](images/CAAPriChangePattern01.gif)
 

![](images/CAAPriChangePattern03.gif)
...
Set 
oSelection = oPartDocument.Selection
...
Set 
oCircularPattern = oSelection.Item(1).Value...
```
