...
tags: ["CATIAHole", "CAAScrBase", "CAAPriChangeHole", "CAAScdPriUseCases", "CATIA"]
source_file: "Doc/online/CAAScdPriUseCases/CAAPriChangeHoleSource.htm"
converted: "2026-05-11T11:06:32.846951"
---
...
Private Function CatObjectExistsInSelection(CatSelection
 As 
Selection, CatObjectName
 As 
String, CatObject
 As 
Object)
...
Set 
CatObject = CatSelection.FindObject(CatObjectName)
CatObjectExistsInSelection = (Err.Number = 0)
Err.Clear

End Function

Private Function ParameterExists(ItemIndex
 As 
...
Set 
TmpItem = ItemCollection.Item(ItemIndex)
