...
tags: ["CATIAHole", "CAAScrBase", "CAAPriChangeHole02", "CAAInfLauchMacro", "CAAPriChangeHole06", "CAAPriChangeHole", "CAAScdInfUseCases", "CAAPriChangeHole05", "CAAlink", "CAAPriChangeHole03", "CAAPriChangeHole04", "CAAScdPriUseCases", "CAAPriChangeHole01", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdPriUseCases/CAAPriChangeHole.htm"
converted: "2026-05-11T11:06:32.861418"
---
...
---
 ...
 |[]This macro shows you how to change the parameters of 
 selected holes (diameter, type, thread definition, etc) from data contained 
 in a text file. Data unit is take into account: Millimeter or Inches.

 This macro allows you to define:

 
- T**he limit type: "Up to next" or 
 "Offset" onl**y.
...
- Whether the hole is threaded or not, and its **
 thread depth** if threaded.
 
- A parameter named "Hole_Description" where its value is a letter 
 corresponding to the applied parameters.
 
 

It modifies the
 [
 *Hole*] object from its methods and properties, and updates the 
 part.
...
- []Open the [
 CAAPriChangeHole.CATPart] document.
 
- Reference the catscript file
 [CAAPriChangeHole.CATScript] 
 in the application 
 
- The text file [
 CAAPriChangeHole.txt] located in the CAAScdPriUseCases module.
...
Load the CAAPriChangeHole.CATPart document that contains three holes.
...
oFile 
=
 oCATIAFileSys.GetFile(sDocPath & "\online\CAAScdPriUseCases\macros\CAAPriChangeHole.txt")
...
oTextSteam 
=
 oFile.OpenAsTextStream("ForReading")
...
...
 ...
 Set 
oParameters = oPartDocument.Part.Parameters.SubList(oHole, 
True
)
...
' ------------
 ...
 If 
ParameterExists("Hole_Description", oParameters) = 
True
