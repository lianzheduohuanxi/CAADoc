...
The CATIA Knowledge Advisor automation objects are those whereby you can create and manipulate the knowledgeware features in a script. These automation objects can be divided into two categories:
  ...
  2. The knowledgeware objects whereby you can manipulate the Parameter, Formula, Rule, Check and  Design Table features once they have been created. The hierarchy of these objects is described in the [Parameter](CAAKniTocParameter.htm) and [Relation](CAAKniTocRelation.htm) tree structures.
