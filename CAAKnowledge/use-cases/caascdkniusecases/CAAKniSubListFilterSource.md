...
tags: ["CAAScrBase", "CAAKniSamplePartR13", "CAAKniSubListFilter", "CAAScdKniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdKniUseCases/CAAKniSubListFilterSource.htm"
converted: "2026-05-11T11:06:32.807514"
---
...
Paraneters
 ...
 Set 
oParamList = oActiveDoc.Part.Parameters
...
i = 1
 to 
oBodies.item(j).Shapes.Count

 if 
oBodies.item(j).Shapes.item(i).name = "Pad.1" then
...
Parameters
 ...
 Set 
oPad1SubList = oParamList.SubList(oBodies.item(j).Shapes.item(i), False)
 for k = 1
 to 
oPad1SubList.Count
