...
tags: ["CAAKniClash", "CAAScrBase", "CAAKniFilterRightBelowRoot", "CAAScdKniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdKniUseCases/CAAKniFilterRightBelowRootSource.htm"
converted: "2026-05-11T11:06:32.809680"
---
...
i = 1
 to 
oActiveDoc.Product.Parameters.Count
...
k = 1
 to 
oProductList.Item(j).Parameters.Count
...
' parameter - Sets the flag to 1
 ...
 if 
 S1 = oProductList.Item(j).Parameters.Item(k).name
 then 
