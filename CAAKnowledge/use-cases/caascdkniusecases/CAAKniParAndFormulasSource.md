...
tags: ["CAAScrBase", "CAAKniSamplePartR13", "CAAKniParAndFormulas", "CAAScdKniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdKniUseCases/CAAKniParAndFormulasSource.htm"
converted: "2026-05-11T11:06:32.820892"
---
...
Document
 ...
 set 
oDoc = CATIA.Documents.Open(sFilePath)
...
If 
(InStr(oActiveDoc.Name,".CATPart")) <> 0 Then 
...
Relations
 ...
 Set 
oRelations = oActiveDoc.Part.Relations
...
Parameters 
 ...
 Set 
oParameters = oActiveDoc.Part.Parameters 
...
oParameters.Count
 ...
 if 
(oParameters.Item(i).Name = "SphereRadius") then
...
Parameter 
 ...
 Set 
oString1 = oParameters.CreateString("ProjectId","CATLifKnowledgeAdvisor")
...
Parameter
 ...
 Set 
oString2 = oParameters.CreateString("ProjectKey","")
...
Parameter 
 ...
 Set 
oStringLength = oParameters.CreateInteger("StringLength",0)
...
Parameter 
 ...
 Set 
oSphereRadius = oParameters.CreateDimension("","LENGTH", 0) 
...
Parameter
 ...
 Set 
oSphereVol = oParameters.CreateDimension("SphereVolume","VOLUME",0)
...
Formula
 ...
 Set 
oFormula1 = oRelations.CreateFormula("Formula1", "", oString2,_
...
Formula
 ...
 Set 
oFormula2 = oRelations.CreateFormula("Formula2", "", oString2,_
...
Formula
 ...
 Set 
oFormula3 = oRelations.CreateFormula("Formula3", "", oStringLength,_
 "ProjectId.Length()" ) 
...
Formula
 ...
 Set 
oFormula4 = oRelations.CreateFormula("Formula4", "", oSphereVol,_
