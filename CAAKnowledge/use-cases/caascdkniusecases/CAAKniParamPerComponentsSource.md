...
tags: ["CAAKniClash", "CAAKniParamPerComponents", "CAAScrBase", "CAAScdKniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdKniUseCases/CAAKniParamPerComponentsSource.htm"
converted: "2026-05-11T11:06:32.811735"
---
...
' InStr is a standard VB function
 ...
 If 
(InStr(oActiveDoc.Name,".CATProduct")) <> 0 Then 
...
Parameters
 ...
 Set 
oParams = oActiveDoc.Product.Parameters
...
oParams.Count
 ...
 if 
oParams.item(i).Parent.Parent.name = "Product1" then 
...
Products
 ...
 Set 
oProductList = oActiveDoc.Product.Products
...
oProductList.Count
 ...
 if 
 oProductList.Item(j).Name = "p2.1" then
