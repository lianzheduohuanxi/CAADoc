...
tags: ["CAAKniDesignTable", "CAAScrBase", "CAAScdKniUseCases", "CATIA"]
source_file: "Doc/online/CAAScdKniUseCases/CAAKniDesignTableSource.htm"
converted: "2026-05-11T11:06:32.817085"
---
...
' if it exists the design table is created in the document
 ...
 if 
(oFileSys.FileExists(sFolderPath) = False)
 then 
...
oRelations.Count
 ...
 if 
oRelations.Item(i).Name = "DesignTable.1" then
...
DesignTable
 ...
 Set 
oDesignTable = oRelations.CreateDesignTable("DesignTable.1","",_
 False,_
 sFolderPath) 
...
Bodies
 ...
 Set 
oBodies = oActiveDoc.Part.Bodies
...
oBodies.Count
 ...
 if 
oBodies.Item(j).Name = "PartBody" then 
...
AnyObject
 ...
 Set 
oPartBody = CATIA.ActiveDocument.Part.Bodies.Item("PartBody") 
...
AnyObject
 ...
 Set 
Pad2 = oPartBody.Shapes.Item("Pad.1")
...
' A limit of 10 rows is specified
 ...
 If 
(oDesignTable.ConfigurationsNb < 10)
 Then
