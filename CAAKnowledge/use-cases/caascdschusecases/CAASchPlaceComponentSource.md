...
tags: ["CAAScrBase", "CATIASchCompatible", "CAASCH_Sample", "CATIASchComponent", "CATIASchCompGraphic", "CATIASchComponent2", "CAASCH_RouteForPlacement2", "CAAScdSchUseCases", "CAASchPlaceComponent", "CATIASchGRRComp", "CATIASchCompatibility", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchPlaceComponentSource.htm"
converted: "2026-05-11T11:06:32.584097"
---
...
'-----------------------------------------------------------------------
 ...
 Set 
objSchGRRCtlg = objSchRoot.GetCompSymbolFromCatalog ("Blocking Valve",objSchCtlgDoc)

 If 
( Not ( objSchGRRCtlg Is Nothing ) )
 Then
...
'---------------------------------------------------------------------
 ...
 Set 
objSchCntblRef = objSchGRRCtlg.GetSchObjOwner

 If 
( Not ( objSchCntblRef Is Nothing ) )
 Then
...
'-------------------------------------------------------------------
 ...
 Set 
objSchComp2Ref = objSchRoot.GetInterface ("CATIASchComponent2",objSchCntblRef)
...
( Not ( objSchComp2Ref Is Nothing ) )
 ...
 If 
( Not ( objSchCompInstA Is Nothing ) )
 Then
...
objSchGRRCVCtlg = objSchRoot.GetCompSymbolFromCatalog ("Control Valve",objSchCtlgDoc)
 ...
 If 
( Not ( objSchGRRCVCtlg Is Nothing ) )
 Then
...
objSchCntblCVRef = objSchGRRCVCtlg.GetSchObjOwner
 ...
 If 
( Not ( objSchCntblCVRef Is Nothing ) )
 Then
...
objSchCompCVRef = objSchRoot.GetInterface ("CATIASchComponent",objSchCntblCVRef)
 ...
 If 
( Not ( objSchCompCVRef Is Nothing ) )
 Then
...
( Not ( objSchCompInstA Is Nothing ) )
 ...
 Set 
objSchCompatInstA = objSchRoot.GetInterface ("CATIASchCompatible", _
 objSchCompInstA)

 Set 
objSchCompGraphInstA = objSchRoot.GetInterface ("CATIASchCompGraphic", _
 objSchCompInstA)

 Set 
objSchGRRCompInstA = GetComponentImage (objSchCompGraphInstA)

 End If

 If 
( Not ( objSchCompatInstA Is Nothing ) And _ 
...
' -- step 3 
 ...
 If 
( Not ( objFinalPlaceInfo is Nothing ) )
 Then
...
' -- step 4 
 ...
 Set 
objSchCompInstB = objSchCompCVRef.PlaceOnComponentWithInfo _
 (objFinalPlaceInfo)

 If 
( Not ( objSchCompInstB is Nothing ) )
 Then
 ...
 End If 
'----If ( Not ( objSchCompatInstA Is Nothing )...

 End If 
'---- If ( Not ( objSchCntblCVRef Is Nothing )...

 End If 
'---- If ( Not ( objSchGRRCVCtlg Is Nothing )...
