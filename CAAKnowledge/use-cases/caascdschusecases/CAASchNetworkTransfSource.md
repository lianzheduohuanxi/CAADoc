...
tags: ["CAAScrBase", "CATIASchAppConnectable", "CAASCH_Network01", "CATIASchGRR", "CATIASchCompGraphic", "CATIASchMovable", "CAAScdSchUseCases", "CATIAProduct", "CAASchNetworkTransf", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchNetworkTransfSource.htm"
converted: "2026-05-11T11:06:32.573075"
---
...
objLGRR_g = objSchTempListFact.CreateListOfObjects
 ...
 Set 
objLSelected_g = objSchTempListFact.CreateListOfObjects

 If 
( Not ( objLCntbl_g Is Nothing ) And _
 Not ( objLGRR_g Is Nothing ) And _
 Not ( objLSelected_g Is Nothing ) )
 Then
...
( intNbNet > 0 )
 ...
 Set 
objSchNet = objLNetWork.Item (1,"CATIASchMovable")
...
Private Sub FindNetworkComponentInst (objSchRootArg
 As 
SchematicRoot)
...
( ( Not ObjGRR Is Nothing ) )
 ...
 If 
(intSelected = 0) Then objLSelected_g.Append objCntbl
