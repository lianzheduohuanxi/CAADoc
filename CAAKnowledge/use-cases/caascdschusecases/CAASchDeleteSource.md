...
tags: ["CAAScrBase", "CATIASchAppConnectable", "CAASCH_Delete01", "CATIASchComponent", "CATIASchAppConnector", "CATIASchRoute", "CAAScdSchUseCases", "CATIAProduct", "CAASchDelete", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchDeleteSource.htm"
converted: "2026-05-11T11:06:32.589164"
---
...
'-----------------------------------------------------------------------
 ...
 Set 
objLRoutes = objSchRoot.GetRoutes

 If 
( Not ( objLRoutes Is Nothing ) )
 Then
 ...
 If 
( Not ( objSchBaseFact Is Nothing ) )
 Then

 Set 
objSchComp = FindComponentInst (objSchRoot)

 If 
( Not ( objSchComp Is Nothing ) )
 Then
 ...
 End If 
'--- If ( Not ( objSchBaseFact Is Nothing ...
...
( intNbRouteAfter > 0 )
 ...
 Set 
objRoute1 = objLRoutes.Item (1, "CATIASchRoute")

 If 
( Not ( objRoute1 Is Nothing ) )
 Then

 Set 
objRCntbl1 = objSchRoot.GetInterface ( _
 "CATIASchAppConnectable", objRoute1)

 If 
( Not ( objRCntbl1 Is Nothing ) )
 Then

 Set 
objAppRCntr1 = FindOpenConnector (objSchRoot,objRCntbl1)

 Set 
objRoute2 = objLRoutes.Item (2, "CATIASchRoute")
 ...
 If 
( Not ( objRoute2 Is Nothing ) )
 Then

 Set 
objRCntbl2 = objSchRoot.GetInterface ( _
 "CATIASchAppConnectable", objRoute2)

 If 
( Not ( objRCntbl2 Is Nothing ) )
 Then

 Set 
objAppRCntr2 = FindOpenConnector (objSchRoot,objRCntbl2)
 ...
 If 
( Not ( objRoute1 Is Nothing ) And _
 Not ( objAppRCntr1 Is Nothing ) And _
 Not ( objAppRCntr2 Is Nothing ) )
 Then
...
Private Function FindComponentInst (objSchRootArg
 As 
SchematicRoot)
 As 
SchComponent
...
intNbComp
 ...
 Set 
objSchComp = objLCompInst.Item (intIndex,"CATIASchComponent")
...
( Not ( objSchComp Is Nothing ) )
 ...
 Set 
objPrd = objSchRootArg.GetInterface ( _
...
( intFound > 0 )
 ...
 Set 
FindComponentInst = objSchRootArg.GetInterface ( _
...
Private Function FindOpenConnector (objSchRootArg
 As 
SchematicRootArg, _
 objRCntblArg
 As 
...
objLFilter = Nothing
 ...
 If 
( Not ( objRCntblArg Is Nothing ) )
 Then

 Set 
objLAppCntr = objRCntblArg.AppListConnectors (objLFilter)

 If 
( Not ( objLAppCntr Is Nothing ) )
 Then
...
Boolean
 ...
 If 
(Not ( objLAppCntr Is Nothing ) And ( intNbCntr > 0 ) And _
 Not ( objSchRootArg Is Nothing ) )
 Then
...
intNbCntr
 ...
 Set 
objAppCntr = objLAppCntr.Item (intIndex,"CATIASchAppConnector")

 If 
( Not ( objAppCntr Is Nothing ) )
 Then

 objAppCntr.AppIsCntrConnected bIsConnected

 If 
( Not ( bIsConnected ) )Then

 Set 
FindOpenConnector = objSchRootArg.GetInterface ( _
 ...
 End If 
'--- If ( Not ( objAppCntr Is Nothing ) ...

 Next

 End If 
'--- If (Not ( objLAppCntr Is Nothing ) ...
