...
tags: ["CAAScrBase", "CAASchCompRefGraphic", "CAASCH_Detail03", "CATIASchGRR", "CATIASchCompGraphic", "CAAScdSchUseCases", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchCompRefGraphicSource.htm"
converted: "2026-05-11T11:06:32.671697"
---
...
'--------------------------------------------------------------------
 ...
 Set 
objCompRefGraphic = objLCompRefs.Item (1,"CATIASchCompGraphic")

 If 
( Not ( objCompRefGraphic Is Nothing ) )
 Then
...
'----------------------------------------------------------------
 ...
 Set 
objUnassocSymbol = GetComponentSymbol (objSchRoot)

 If 
( Not ( objUnassocSymbol Is Nothing ) )
 Then
...
SchListOfObjects
 ...
 Set 
objLGraphic = objCompRefGraphic.ListGraphicalRepresentations
 

 If 
( Not ( objLGraphic Is Nothing ) )
 Then
...
(intNbGraphic > 1)
 ...
 Set 
objGRR = objLGraphic.Item(intNbGraphic,"CATIASchGRR")
...
'--- If ( Not ( objLGraphic Is Nothing ) ) Then
 ...
 End If 
'--- If ( Not ( objCompRefGraphic Is Nothing )...

 End If 
'--- If ( Not ( objLCompRefs Is Nothing ) ...
