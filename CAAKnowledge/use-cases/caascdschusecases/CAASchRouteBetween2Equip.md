...
tags: ["CAAScrBase", "CAASchPlatformModeler", "CAASchRouteBetween2Equip_01", "CAASCHEDUConnector", "CAADoc", "CAASCH_RouteBetween2Equip", "CAASCHEDUApp", "CAAScdInfUseCases", "CATIASchCompGraphic", "CAAScdSchUseCases", "CAASchRouteBetween2Equip_02", "CAAScrJavaScript", "CAASchAppBase", "CAASchAppUtilities", "CAASCHEDUFuncString", "CAASchRouteBetween2EquipSource", "CATIAProduct", "CAAInfLauchMacro", "CAASchRouteBetween2Equip", "CATIASchCompatible"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchRouteBetween2Equip.htm"
converted: "2026-05-11T11:06:32.598207"
---

## Schematics Platform Modeler
 
 
## []Creating a Schematic Route between two Schematic 
 Equipments
...
Through special naming convention, the macro knows how to identity the 
 ...
 their instance names will be used.
 

 ![](images/CAASchRouteBetween2Equip_01.jpg)
 
 
 ![](../CAAScrBase/images/ainfo.gif)
 |[]CAASchRouteBetween2Equip is launched in 
...
- Copy CAASchPlatformModeler.edu\CNext\code\dictionary\CAASchPlatformModeler.edu.dico 
 ...
 [
 CAASchRouteBetween2Equip.CATScript ]is located in the CAAScdSchUseCases 
 module. [Execute macro] 
 (Windows only).
 
 
 ![](../CAAScrBase/images/ascenari.gif)
 |[]CAASchRouteBetween2Equip includes the 
 following steps:
