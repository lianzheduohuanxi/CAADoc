...
tags: ["CAAScrBase", "CAASchNetwork", "CATIASchAppConnectable", "CAASCH_Network01", "CATIASchGRR", "CATIASchCompGraphic", "CATIASchNetworkAnalysis", "CAAScdSchUseCases", "CATIAProduct", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchNetworkSource.htm"
converted: "2026-05-11T11:06:32.603365"
---
...
( Not ( objSchBaseFact Is Nothing ) And _
 ...
 Set 
objLCntbl_g = objSchTempListFact.CreateListOfObjects

 Set 
objLGRR_g = objSchTempListFact.CreateListOfObjects

 If 
( Not ( objLCntbl_g Is Nothing ) And _
 Not ( objLGRR_g Is Nothing ) )
 Then
...
'-----------------------------------------------------------------
 ...
 Set 
objLNetWork = objSchBaseFact.CreateNetwork (objLCntbl_g, _
 objLGRR_g) 
...
intNbNet 
 ...
 Set 
objLNetMember = Nothing

 Set 
objSchNet = objLNetWork.Item (intNetIndex,"CATIASchNetworkAnalysis")
...
'---------------------------------------------------------------------
 ...
 If 
( Not ( objSchNet Is Nothing ) )
 Then

 Set 
objLNetMember = objSchNet.ListNetworkObjects

 End If 

 If 
( Not ( objLNetMember Is Nothing ) )
 Then
...
intNbMember
 ...
 Set 
objMemPrd = objLNetMember.Item (intMemIndex,"CATIAProduct")
 strName = ""

 If 
( Not ( objMemPrd Is Nothing ) )
 Then
...
'--- For intMemIndex
 ...
 End If 
'--- If ( Not ( objLNetMember Is Nothing ) ...
...
( Not ( objSchNet Is Nothing ) )
 ...
 Set 
objLNetMember = objSchNet.ListExtremityObjects
...
SchematicRoot)
 ...
 If 
( objLCntbl_g Is Nothing ) Then Exit Sub

 If 
( objLGRR_g Is Nothing ) Then Exit Sub
...
intNbComp
 ...
 Set 
objCntbl = objLCompInst.Item (intIndex,"CATIASchAppConnectable")

 If 
( Not ( objCntbl Is Nothing ) )
 Then
...
SchCompGraphic
 ...
 Set 
objSchCompGraph = objSchRootArg.GetInterface ( _
 "CATIASchCompGraphic",objCntbl)

 Set 
objGRR = GetComponentImage (objSchCompGraph)
...
( Not ( objSchLSymbols Is Nothing ) )
 ...
 Set 
GetComponentImage = objSchLSymbols.Item (1,"CATIASchGRR")
