...
tags: ["CAAScrBase", "CAASCHEDU_SamplePID", "CAASCHEDUConnector", "CATIASchCompConnector", "CATIASchCntrLocation", "CATIASchCompGraphic", "CATIASchAppConnector", "CAAScdSchUseCases", "CATIASchAppConnectable", "CAASCHEDUCompressFunc", "CAASCHEDUFuncString", "CAASCH_Detail01", "CAASchAppObjFactory", "CATIASchCompatible", "CATIASchGRR", "CATIASchListOfBSTRs", "CATIASchComponent2", "CATIASchRouteGraphic", "CATIASchGRRComp", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchAppObjFactorySource.htm"
converted: "2026-05-11T11:06:32.700741"
---
...
'-----------------------------------------------------------------------
 ...
 Set 
objAppObjFact = objSchRoot.GetApplObjFactFromVirtualType ("CAASCHEDU_SamplePID")

 Set 
objSchBaseFact = objSchRoot.GetSchBaseFactory 

 Set 
objSchTempListFact = objSchRoot.GetTemporaryListFactory

 If 
( Not ( objAppObjFact Is Nothing ) And _
...
'--------------------------------------------------------------------- 
 ...
 Set 
objSchSymbol = GetComponentSymbol (objSchRoot)

 If 
( Not ( objSchSymbol Is Nothing ) )
 Then

 Set 
objSchListGRR = objSchTempListFact.CreateListOfObjects

 If 
( Not ( objSchListGRR Is Nothing ) )
 Then

 objSchListGRR.Append objSchSymbol

 Set 
objSchCompRef = objSchBaseFact.CreateSchComponent ( _
 objAppCompRef, objSchListGRR)

 If 
( Not ( objSchCompRef Is Nothing ) )
 Then
...
SchCntrLocation
 ...
 Set 
objSchCntr = objSchRoot.GetInterface ("CATIASchCompConnector", _
 objSchCompRef)

 If 
( Not ( objSchCntr Is Nothing ) )
 Then
...
2
 ...
 Set 
objSchCntrLoc = Nothing

 Set 
objSchAppCntr = Nothing
...
( iCntr = 1 )
 ...
 If 
( Not ( objSchAppCntr Is Nothing ) )
 Then

 Set 
objSchCntrLoc = objSchRoot.GetInterface ( _
 "CATIASchCntrLocation", objSchAppCntr)

 If 
( Not ( objSchCntrLoc Is Nothing ) )
 Then
...
CATSafeArrayVariant
 ...
 Set 
objSchComp2Ref = objSchRoot.GetInterface ( _
 "CATIASchComponent2",objAppCompRef)

 If 
( Not ( objSchComp2Ref Is Nothing ) )
 Then
...
SchCompatible
 ...
 Set 
objSchCompGraphic = objSchRoot.GetInterface ( _
...
'-------------------------------------------------------------------
 ...
 If 
( Not ( objSchCompGraphic Is Nothing ) )
 Then

 Set 
objSchGRRCompInst = GetComponentImage (objSchCompGraphic) 

 End If 

 Set 
objSchCompCompat = objSchRoot.GetInterface ( _
 "CATIASchCompatible",objSchCompInst)

 If 
( Not ( objSchCompCompat Is Nothing ) And _ 
 Not ( objSchGRRCompInst Is Nothing ) )
 Then
...
CATSafeArrayVariant
 ...
 Set 
objSchGRRInst = objSchRoot.GetInterface ( _
 "CATIASchGRR",objSchGRRCompInst)

 If 
( Not ( objLCntrs Is Nothing ) And _
 Not ( objSchGRRInst Is Nothing ) And bCompatible )
 Then
...
( Not ( objSchRoute Is Nothing ) )
 ...
 Set 
objRouteCntbl = objSchRoot.GetInterface ( _
 "CATIASchAppConnectable",objSchRoute)

 Set 
objAppCntrRouteBest = FindConnectorAtPosition ( _
 dbPtArray(0), dbPtArray(1), objRouteCntbl, objSchRoot)

 If 
( Not (objAppCntrRouteBest Is Nothing ) And _
 Not (objAppCntrCompBest Is Nothing ) )
 Then
...
'-----------------------------------------------------
 ...
 Set 
objAppConnection = objAppCntrCompBest.AppConnect _
 (objAppCntrRouteBest)
...
'--- If ( Not ( objAppCompRef Is Nothing ) ...
 ...
 End If 
'--- If ( Not ( objLCntrs Is Nothing )...

 End If 
'--- If ( Not ( objSchCompCompat Is Nothing ) ...

 End If 
'--- If ( Not ( objSchCompInst Is Nothing ) ...

 End If 
'--- If ( Not ( objAppObjFact Is Nothing )...
...
Private Function GetComponentSymbol (objSchRootArg
 As 
SchematicRoot)
 As 
AnyObject
...
( Not ( objSchRootArg Is Nothing ) )
 ...
 Set 
objSchLSymbols = objSchRootArg.GetUnassociatedSymbols
...
( Not ( objSchLSymbols Is Nothing ) )
 ...
 Set 
GetComponentSymbol = objSchLSymbols.Item (1,"CATIASchGRR")
...
objLCntr = objSchCntblArg.AppListConnectors (objLFilter)
 ...
 Set 
objSchRouteGraphic = objSchRootArg.GetInterface ( _
...
objGRR = GetRoutePrimitives (objSchRouteGraphic)
 ...
 End If 
'--- If ( Not ( objSchCntblArg Is Nothing ) ...
...
( ( dbXOut = dbXArg ) And _ 
 ...
 Set 
FindConnectorAtPosition = objSchRootArg.GetInterface ( _
