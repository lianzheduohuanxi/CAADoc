...
tags: ["CAAScrBase", "CATIASchAppConnectable", "CAASchInternalFlow", "CATIASchCompFlow", "CATIASchComponent", "CAASCH_Detail02", "CATIASchAppConnector", "CAAScdSchUseCases", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchInternalFlowSource.htm"
converted: "2026-05-11T11:06:32.704639"
---
...
objSchTempListFact = objSchRoot.GetTemporaryListFactory
 ...
 If 
( Not ( objSchRoot Is Nothing ) And _
...
'-----------------------------------------------------------------------
 ...
 Set 
objLCompRefs = objSchRoot.GetRefComponents

 If 
( Not ( objLCompRefs Is Nothing ) )
 Then

 Set 
objCompRef = objLCompRefs.Item (1,"CATIASchComponent")

 If 
( Not ( objCompRef Is Nothing ) )
 Then

 Set 
objCompFlow = objSchRoot.GetInterface ( _
 "CATIASchCompFlow",objCompRef)

 Set 
objCntbl = objSchRoot.GetInterface ( _
 "CATIASchAppConnectable",objCompRef)

 End If 

 If 
( Not ( objCntbl Is Nothing ) And _ 
 Not ( objCompFlow Is Nothing ) )
 Then
...
objLFilter = Nothing
 ...
 Set 
objLCntr = objCntbl.AppListConnectors (objLFilter)
...
SchListOfObjects
 ...
 Set 
objLCntr1 = objSchTempListFact.CreateListOfObjects

 Set 
objLCntr2 = objSchTempListFact.CreateListOfObjects
...
objCntr3 = Nothing
 ...
 If 
( intNbCntr > 0 ) Then Set objCntr1 = objLCntr.Item(1,"CATIASchAppConnector")

 If 
( intNbCntr > 1 ) Then Set objCntr2 = objLCntr.Item(2,"CATIASchAppConnector")

 If 
( intNbCntr > 2 ) Then Set objCntr3 = objLCntr.Item(3,"CATIASchAppConnector")

 Set 
objFlow1 = Nothing

 If 
( Not objLCntr1 Is Nothing )
 Then

 If 
( Not ( objCntr1 Is Nothing ) And _
 Not ( objCntr2 Is Nothing ) )
 Then
 ...
 Set 
objFlow1 = objCompFlow.AddInternalFlow (objLCntr1)

 If 
( Not ( objFlow1 Is Nothing ) )
 Then
 ...
 End If 
'--- If ( Not objLCntr1 Is Nothing...

 Set 
objFlow2 = Nothing

 If 
( Not objLCntr2 Is Nothing )
 Then

 If 
( Not ( objCntr1 Is Nothing ) And _
 Not ( objCntr3 Is Nothing ) )
 Then
 ...
 Set 
objFlow2 = objCompFlow.AddInternalFlow (objLCntr2)

 If 
( Not ( objFlow2 Is Nothing ) )
 Then
...
'-----------------------------------------------------------------
 ...
 Set 
objLFlow = objCompFlow.ListInternalFlows 
