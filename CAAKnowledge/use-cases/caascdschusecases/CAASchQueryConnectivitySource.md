...
tags: ["CAAScrBase", "CATIASchAppConnectable", "CAAScdSchUseCases", "CATIASchCntrLocation", "CATIASchGRR", "CATIASchCompGraphic", "CATIASchRouteGraphic", "CAASCH_CompRoute01", "CAASchQueryConnectivity", "CATIAProduct", "CATIA"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchQueryConnectivitySource.htm"
converted: "2026-05-11T11:06:32.636667"
---
...
' ------------------------------------------------------------------------- 
 ...
 If 
( Not ( objSchLComps Is Nothing ) And _
 Not ( objSchRoot Is Nothing ) )
 Then

 
 int
Nb = objSchLComps.Count
...
( Not ( objPrd Is Nothing ) )
 ...
 Set 
objAppCntbl = objSchRoot.Ge
tInt
erface ("CATIASchAppConnectable",objPrd)

 If 
( Not ( objAppCntbl Is Nothing ) )
 Then
...
objLFilter = Nothing
 ...
 Set 
objLCntblOther = Nothing

 Set 
objLCntrThis = Nothing

 Set 
objLCntrOther = Nothing
...
' --- If (intNb > 0) Then
 ...
 End If 
'--- If ( Not ( objSchLComps Is Nothing ) And ...
...
' ------------------------------------------------------------------------- 
 ...
 If 
( Not ( objSchLRoutes Is Nothing ) And _
 Not ( objSchRoot Is Nothing ) )
 Then

 
 int
Nb = objSchLRoutes.Count
...
Private Sub GenerateALine (objSchRootArg
 As 
SchematicRoot, _
 objLCntblArg
 As 
SchListOfObjects, objLCntrArg
 As 
SchListOfObjects)
...
String
 ...
 If 
( Not ( objLCntblArg Is Nothing ) And _
 Not ( objLCntrArg Is Nothing ) )
 Then

 
 int
NbCntbl = objLCntblArg.Count
 
 int
NbCntr = objLCntrArg.Count
...
objPrd = Nothing
 ...
 Set 
objPrd = objLCntblArg.Item (intIndex,"CATIAProduct")
 

 Set 
objCntbl = objSchRootArg.Ge
tInt
erface ("CATIASchAppConnectable",objPrd)
...
objGRR = Nothing
 ...
 Set 
objGRR = GetImage (objSchRootArg, objCntbl)
...
( Not ( objGRR Is Nothing ) )
 ...
 Set 
objCntr = objLCntrArg.Item (intIndex,"CATIASchCntrLocation")
...
objLDb = Nothing
 ...
 If 
( Not ( objLDb Is Nothing ) )
 Then

 
 int
NbCoord = objLDb.Count
...
'--- If ( intNbCntbl = intNbCntr ) Then ...
 ...
 End If 
'--- If ( Not ( objLCntblArg Is Nothing ) And ...
...
Private Function GetImage (objSchRootArg
 As 
SchematicRoot, _
 objSchCntblArg
 As 
...
Integer
 ...
 Set 
objSchCompGraph = Nothing

 Set 
objSchRouteGraph = Nothing

 If 
( Not ( objSchRootArg Is Nothing ) And _
 Not ( objSchCntblArg Is Nothing ) )
 Then
...
'-------------------------------------------------------------------------
 ...
 Set 
objSchRouteGraph = objSchRootArg.Ge
tInt
erface ( _
...
erface ( _
 ...
 If 
( Not ( objSchCompGraph Is Nothing ) )
 Then

 Set 
objSchLImages = objSchCompGraph.ListGraphicalImages
 Else 
...
( Not ( objSchRouteGraph Is Nothing ) )
 ...
 Set 
objSchLImages = objSchRouteGraph.ListGraphicalPrimitives
 ...
 If 
( Not ( objSchLImages Is Nothing ) )
 Then

 Set 
GetImage = objSchLImages.Item (1,"CATIASchGRR")
