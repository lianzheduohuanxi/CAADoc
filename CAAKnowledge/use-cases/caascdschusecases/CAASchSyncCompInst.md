...
tags: ["CAAScrBase", "CAAInfLauchMacro", "CAASCH_SyncCompInst", "CAASchSyncCompInstSource", "CATIASchUpdateInstances", "CAASchSyncCompInst_01", "CATIASchComponent", "CAAScdInfUseCases", "CAASchSyncCompInst", "CAAScdSchUseCases", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdSchUseCases/CAASchSyncCompInst.htm"
converted: "2026-05-11T11:06:32.708020"
---
...
---
 ...
 the changes in the corresponding catalog reference.
...
This macro opens the CAASCH_SyncCompInst.CATProduct document.
...
[CAASchSyncCompInst.CATScript ]is located in the CAAScdSchUseCases 
...
The macro first loads CAASCH_SyncCompInst.CATProduct.
...
    End If
 ...
     ' Get SchUpdateInstances interface on the schematic
 root.
...
The macro calls UpdateAllInstancesFromReference method of SchUpdateInstance interface
 ...
 |    ' Synchronize component instances of the
