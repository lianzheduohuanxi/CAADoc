...
  |
  ...
  1. Select **Tools- >Customize** , then the '**Commands** ' tab, and Macros. Select the '**Macros** ' under '**Categories** ' ![](images/CAAInfAdd2.jpg)
...
  |
  ...
  1. To select another icon than the default one,click on ![](images/CAAInfIicon1.jpg)

  |

  1. Select the appropriate icon from '**Icon Browser** '
![](images/CAAInfAdd3.jpg)

  |

  1. You can also use the local icon using ![](images/CAAInfIcon2.jpg)
