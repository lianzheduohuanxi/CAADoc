 ...
 * * *
 ...
 ![](../CAAScrBase/images/atarget.gif) |  This macro shows you how to save a new CATIA document that is currently in the session. In order to save an existing CATIA document in the same storage location and under the same name, see the CAAInfSaveDocument [1] sample for a detailed description.    
 ---|---  
 ![](../CAAScrBase/images/ainfo.gif) |  CAAInfSaveAsDocument is launched in CATIA [2]. An existing document called "CAAInfReadDocument.CATPart" must be found in the CATDocView. [CAAInfSaveAsDocument.CATScript ](CAAInfSaveAsDocumentSource.htm)is located in the CAAScdInfUseCases module. [Execute macro](macros/CAAInfSaveAsDocument.CATScript) (Windows only).    
 ![](../CAAScrBase/images/ascenari.gif) |  CAAInfSaveAsDocument includes five steps:
 ...
 * * *
 ...
 [1] | [Saving an Existing CATIA Document](CAAInfSaveDocument.htm)  
 ---|---  
 [2] | [Replaying a Macro](CAAInfLauchMacro.htm)  
 [3] | [Creating a New CATIA Document](CAAInfCreateDocument.htm)  
