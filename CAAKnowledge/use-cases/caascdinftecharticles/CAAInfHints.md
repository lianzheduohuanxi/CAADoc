...
> For i = 0 To Ubound(myArray)
 ...
 The [ CAA V5 Automation Coding Rules](../CAAScrTechArticles/CAAScrScriptCodingRules.htm) Technical Article contains portability rules that describe in more details a few points that must also be considered to write portable code.
