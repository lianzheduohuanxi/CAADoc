...
tags: ["CAAScrBase", "CAAInfCreateDocument", "CAAInfLauchMacro", "CAAInfCloseDocument", "CAAInfReadDocument", "CAAScdInfUseCases", "CAAInfSaveAsDocument", "CAAInfWriteDocument2", "CAAInfSaveAsDocumentSource", "CAAInfWriteDocument3", "CAAInfSaveDocument", "CAAInfWriteDocument1", "CATIA", "CAAScrJavaScript"]
source_file: "Doc/online/CAAScdInfUseCases/CAAInfSaveAsDocument.htm"
converted: "2026-05-11T11:06:32.793123"
---
...
[]This macro shows you how to save a new CATIA
 ...
 the CAAInfSaveDocument [[1]] sample for a detailed
 description.
...
If
 (
Not
 CATIA.FileSystem.FolderExists(sTmpPath))
 Then
...
Set
 oFirstNewPartDoc = CATIA.Documents.
Add
("Part")
...
Set
 oSecondNewPartDoc = CATIA.Documents.Add("Part")
...
Set
 iThirdPartDoc = CATIA.Documents.Open(sDocPath & _
