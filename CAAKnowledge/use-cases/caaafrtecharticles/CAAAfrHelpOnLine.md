...
---|---  
GeoWs_C2/GeoWspoint.htm | Relative position of the HTML page for the Point command in the documentation file tree . It is always the same syntax: **ModuleName/CommandPageName.htm  **
...
>   * ![](../CAAIcons/images/hand.gif)**icons_xxx** : the directory which contains the no_navigation.htm file. 
> 
...
[3] | [Application Property Access](../CAACafTechArticles/CAACafToolsOptions.htm)  
[4] | [What Is the Product Line Visual Identity](CAAAfrVisualIdentity.htm)  
[5] | [Creating a Product Line Visual Identity](../CAAAfrUseCases/CAAAfrSampleVisualIdentity.htm)  
[6] | [Contextual Help for an Add-On](../CAAAfrUseCases/CAAAfrSampleContextualHelpCATIA.htm)  
[Top]  
