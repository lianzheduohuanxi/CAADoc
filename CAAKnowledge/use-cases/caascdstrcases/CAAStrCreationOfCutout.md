...
![Target Icon](../CAAScrBase/images/atarget.gif) |  This macro shows you how to create cutout on structure objects. Here we will place cutout on Plate using After Forming as well as Before Forming modes. ![Starting Product](images/CAAScdStrCutout01.png)  
---|---  
![Information Icon](../CAAScrBase/images/ainfo.gif) |  CAAStrCreateCutout is launched in CATIA [1]. Some documents are needed.

  * [CAAStrCreateCutout.CATScript](CAAStrCreationOfCutoutSource.htm) is located in the CAAScdStrUseCases module. [Execute macro](macros/CAAStrCreateCutout.CATScript) (Windows only).
...
![Scenario Icon](../CAAScrBase/images/ascenari.gif) |  CAAStrCreateCutout includes four steps:
