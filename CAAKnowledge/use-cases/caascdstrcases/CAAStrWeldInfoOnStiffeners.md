...
![Target Icon](../CAAScrBase/images/atarget.gif) |  This macro shows you how to retrieve Weld information already set on SDD Stiffener Objects. ![Starting Part](images/CAAScdStrWeldInfo01.png)  
---|---  
![Information Icon](../CAAScrBase/images/ainfo.gif) |  CAAStrWeldInfoOnStiffeners is launched in CATIA [1]. Some documents are needed.

  * [ CAAStrWeldInfoOnStiffeners.CATScript](CAAStrWeldInfoOnStiffenersSource.htm) is located in the CAAScdStrUseCases module. [Execute macro](macros/CAAStrWeldInfoOnStiffeners.CATScript) (Windows only).
  * The document CAAStrWeldInfoOnStiffeners.CATPart is located in the CAAScdStrUseCases module in the samples directory.

  
![Scenario Icon](../CAAScrBase/images/ascenari.gif) |  CAAStrWeldInfoOnStiffeners includes the following steps:
