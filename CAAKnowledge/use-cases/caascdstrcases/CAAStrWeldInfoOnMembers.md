...
![Target Icon](../CAAScrBase/images/atarget.gif) |  This macro shows you how to retrieve Weld information already set on SDD Member Objects. ![Starting Part](images/CAAScdStrWeldInfo02.png)  
---|---  
![Information Icon](../CAAScrBase/images/ainfo.gif) |  CAAStrWeldInfoOnMembers is launched in CATIA [1]. Some documents are needed.

  * [ CAAStrWeldInfoOnMembers.CATScript](CAAStrWeldInfoOnMembersSource.htm) is located in the CAAScdStrUseCases module. [Execute macro](macros/CAAStrWeldInfoOnMembers.CATScript) (Windows only).
  * The CAAStrWeldInfoOnMembers.CATPart is located in the samples directory.

  
![Scenario Icon](../CAAScrBase/images/ascenari.gif) |  CAAStrWeldInfoOnMembers includes the following steps:
