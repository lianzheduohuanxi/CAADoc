...
![](../CAAScrBase/images/atarget.gif) | This macro shows you how to query for information from a Schematic design document. The information includes the following:
...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAASchQueryCompRoute is launched in CATIA [1]. No open document is needed.Special environment must be available to successfully run this macro:
...
[CAASchQueryCompRoute.CATScript ](CAASchQueryCompRouteSource.htm) is located in the CAAScdSchUseCases module. [Execute macro](macros/CAASchQueryCompRoute.CATScript) (windows only).  
![](../CAAScrBase/images/ascenari.gif) | CAASchQueryCompRoute includes the following steps:
