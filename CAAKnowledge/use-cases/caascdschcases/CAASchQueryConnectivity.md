...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAASchQueryConnectivity is launched in CATIA [1]. No open document is needed.Special environment must be available to successfully run this macro:
...
[ CAASchQueryConnectivity.CATScript ](CAASchQueryConnectivitySource.htm)is located in the CAAScdSchUseCases module. [Execute macro](macros/CAASchQueryConnectivity.CATScript) (Windows only).  
![](../CAAScrBase/images/ascenari.gif) | CAASchQueryConnectivity includes the following steps:
