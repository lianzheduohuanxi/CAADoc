...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAASchAppObjFactory is launched in CATIA [1]. No open document is needed.Special environment must be available to successfully run this macro:
...
[CAASchAppObjFactory.CATScript](CAASchAppObjFactorySource.htm) is located in the CAAScdSchUseCases module. [Execute macro](macros/CAASchAppObjFactory.CATScript) (Windows only).  
![](../CAAScrBase/images/ascenari.gif) | CAASchAppObjFactory includes the following steps:
