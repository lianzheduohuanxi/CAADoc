...
---|---  
![](../CAAScrBase/images/ainfo.gif) | CAASchCreateSchDocument2 is launched in CATIA [1]. No open document is needed. [ CAASchCreateSchDocument2.CATScript ](CAASchCreateSchDocument2Source.htm)is located in the CAAScdSchUseCases module. [Execute macro](macros/CAASchCreateSchDocument2.CATScript) (Windows only).  
![](../CAAScrBase/images/ascenari.gif) | CAASchCreateSchDocument2 includes the following steps:
