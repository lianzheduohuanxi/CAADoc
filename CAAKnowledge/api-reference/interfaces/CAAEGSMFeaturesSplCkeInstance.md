---
title: "CAAEGSMFeaturesSplCkeInstance"
type: "interface"
module: "CAAGSMInterfaces"
category: api-reference
base: "CATKweInstanceAdapter"
inheritance_chain: "CAAEGSMFeaturesSplCkeInstance → CATKweInstanceAdapter"
method_count: 0
visibility: "local"
...
**继承链**: CAAEGSMFeaturesSplCkeInstance → CATKweInstanceAdapter  
**模块**: CAAGSMInterfaces  
**分类**: framework  
**可见性**: local  
**方法数**: 0
