...
inheritance_chain: "CAAEV5V6ExtMmrCombinedCurveBehavior → CATIFmFeatureBehaviorCustomization"
method_count: 9
visibility: "local"
...
**继承链**: CAAEV5V6ExtMmrCombinedCurveBehavior → CATIFmFeatureBehaviorCustomization  
