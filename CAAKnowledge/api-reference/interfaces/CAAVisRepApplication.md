...
inheritance_chain: "CAAVisRepApplication → CATInteractiveApplication"
method_count: 2
visibility: "local"
...
**继承链**: CAAVisRepApplication → CATInteractiveApplication  
**模块**: CAAVisualization  
**分类**: framework  
**可见性**: local  
**方法数**: 2
...
- [CAAVisSampleGraphicAtt](../../use-cases/caaviscases/CAAVisSampleGraphicAtt.md)
