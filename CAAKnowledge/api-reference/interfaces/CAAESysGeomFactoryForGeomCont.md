...
base: "CATBaseUnknown"
method_count: 1
source_file: "CAASystem.edu/CAASysGeoModelImpl.m/LocalInterfaces/CAAESysGeomFactoryForGeomCont.h"
---

# CAAESysGeomFactoryForGeomCont

> Data Extension of CAASysGeomCont to implement the CAAISysGeomFactory interface which enables to create the objects. Main Methods: Create   -> Constructs a new CATObject
...
**源文件**: `CAASystem.edu/CAASysGeoModelImpl.m/LocalInterfaces/CAAESysGeomFactoryForGeomCont.h`
